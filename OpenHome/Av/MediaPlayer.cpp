    ...
    , iConfigProductName(NULL)
{
    ...
    iProviderVolume = ProviderFactory::NewVolume(*iProduct, aDevice, *iConfigManager, iReadWriteStore, *iPowerManager, iVolumeProfile, iVolume, iVolumeLimit, iBalance, iMute);

...
void ProviderRadio::NotifyPresetInfo(TUint aPresetId, const Brx& aUri, const Brx& aMetadata)
{
    AutoMutex a(iLock);
    iUri.Replace(aUri);
...
{
    AutoMutex _(iActionLock);
    NotifyPresetInfo(IPresetDatabaseReader::kPresetIdNone, aUri, aMetadata);

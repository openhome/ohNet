...
SourceRadio::SourceRadio(Environment& aEnv, DvDevice& aDevice, PipelineManager& aPipeline, UriProviderSingleTrack& aUriProvider, const Brx& aProtocolInfo, Configuration::ConfigurationManager& aConfigManager)
    : Source("Radio", "Radio")
    , iLock("SRAD")
    , iPipeline(aPipeline)

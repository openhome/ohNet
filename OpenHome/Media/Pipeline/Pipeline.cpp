    ...
    , iNextFlushId(MsgFlush::kIdInvalid + 1)
{
    ...
    iVariableDelay1 = new VariableDelay("VariableDelay1", *iMsgFactory, *iDecodedAudioValidatorSeeker,
    ...
    iVariableDelay2 = new VariableDelay("VariableDelay2", *iMsgFactory, *iLoggerDrainer,

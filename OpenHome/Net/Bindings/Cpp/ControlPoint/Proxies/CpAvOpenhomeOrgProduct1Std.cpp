    ...
    : CpProxy("av-openhome-org", "Product", 1, aDevice.Device())
{
    ...
    iProductRoom = new PropertyString(aDevice.Device().CpStack().Stack(), "ProductRoom", functor);

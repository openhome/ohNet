...
/**
* Service Proxy for CpProxySchemasUpnpOrgRenderingControl1
* @module ohnet
...
var CpProxySchemasUpnpOrgRenderingControl1 = function(udn){ 
    ...
    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/upnp.org-RenderingControl-1/control";  // upnp control url
    this.domain = "schemas-upnp-org";
    this.type = "RenderingControl";
    this.version = "1";
    this.serviceName = "upnp.org-RenderingControl-1";

...
public class DvProviderUpnpOrgRenderingControl2 extends DvProvider implements IDvProviderUpnpOrgRenderingControl2
{
     ...
     */
    protected String setStateVariables(int aVersion, long aInstanceID, String aRenderingControlUDN, String aServiceType, String aServiceId, String aStateVariableValuePairs)
    {
        throw (new ActionDisabledError());
    }
    ...
    private class DoSetStateVariables implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation, int aVersion)
        {
            ...
            try
            {
                ...
                invocation.readEnd();
                 stateVariableList = setStateVariables(aVersion, instanceID, renderingControlUDN, serviceType, serviceId, stateVariableValuePairs);
            }
            catch (ActionError ae)
            {
                invocation.reportError(501, "Invalid XML");

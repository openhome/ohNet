...
interface IDvProviderUpnpOrgAVTransport2
{
 ...
 */
public class DvProviderUpnpOrgAVTransport2 extends DvProvider implements IDvProviderUpnpOrgAVTransport2
{
    ...
    private IDvInvocationListener iDelegateGetMediaInfo_Ext;
    ...
    private IDvInvocationListener iDelegateGetDRMState;
    ...
    public String getPropertyDRMState()
    {
        return iPropertyDRMState.getValue();
    }
    ...
    {
        Action action = new Action("GetMediaInfo_Ext");        List<String> allowedValues = new LinkedList<String>();
        action.addInputParameter(new ParameterUint("InstanceID"));
    ...
    {
        Action action = new Action("GetDRMState");
        action.addInputParameter(new ParameterUint("InstanceID"));
        action.addOutputParameter(new ParameterRelated("CurrentDRMState", iPropertyDRMState));
        iDelegateGetDRMState = new DoGetDRMState();
        enableAction(action, iDelegateGetDRMState);
    }
    ...
    private class DoGetMediaInfo_Ext implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            ...
            {
                invocation.reportActionError(ae, "GetMediaInfo_Ext");
                return;
            }
            catch (PropertyUpdateError pue)
            {
    ...
    private class DoGetDRMState implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            ...
            {
                invocation.reportActionError(ae, "GetDRMState");
                return;
            }
            catch (PropertyUpdateError pue)
            {

    ...
    , iLock("MPCS")
{
    ...
    iTrackCount = new PropertyUint(reinterpret_cast<CpiDevice*>(aDevice)->CpStack().Stack(), "TrackCount", functor);
    AddProperty(iTrackCount);
    functor = MakeFunctor(*this, &CpProxyAvOpenhomeOrgInfo1C::DetailsCountPropertyChanged);
    iDetailsCount = new PropertyUint(reinterpret_cast<CpiDevice*>(aDevice)->CpStack().Stack(), "DetailsCount", functor);
    AddProperty(iDetailsCount);
    functor = MakeFunctor(*this, &CpProxyAvOpenhomeOrgInfo1C::MetatextCountPropertyChanged);
    iMetatextCount = new PropertyUint(reinterpret_cast<CpiDevice*>(aDevice)->CpStack().Stack(), "MetatextCount", functor);
    AddProperty(iMetatextCount);
    functor = MakeFunctor(*this, &CpProxyAvOpenhomeOrgInfo1C::UriPropertyChanged);
    iUri = new PropertyString(reinterpret_cast<CpiDevice*>(aDevice)->CpStack().Stack(), "Uri", functor);
    AddProperty(iUri);
    ...
    iDuration = new PropertyUint(reinterpret_cast<CpiDevice*>(aDevice)->CpStack().Stack(), "Duration", functor);
    AddProperty(iDuration);
    functor = MakeFunctor(*this, &CpProxyAvOpenhomeOrgInfo1C::BitRatePropertyChanged);
    iBitRate = new PropertyUint(reinterpret_cast<CpiDevice*>(aDevice)->CpStack().Stack(), "BitRate", functor);
    AddProperty(iBitRate);
    functor = MakeFunctor(*this, &CpProxyAvOpenhomeOrgInfo1C::BitDepthPropertyChanged);
    iBitDepth = new PropertyUint(reinterpret_cast<CpiDevice*>(aDevice)->CpStack().Stack(), "BitDepth", functor);
    AddProperty(iBitDepth);
    functor = MakeFunctor(*this, &CpProxyAvOpenhomeOrgInfo1C::SampleRatePropertyChanged);
    iSampleRate = new PropertyUint(reinterpret_cast<CpiDevice*>(aDevice)->CpStack().Stack(), "SampleRate", functor);
    AddProperty(iSampleRate);
    functor = MakeFunctor(*this, &CpProxyAvOpenhomeOrgInfo1C::LosslessPropertyChanged);
    iLossless = new PropertyBool(reinterpret_cast<CpiDevice*>(aDevice)->CpStack().Stack(), "Lossless", functor);
    AddProperty(iLossless);
    functor = MakeFunctor(*this, &CpProxyAvOpenhomeOrgInfo1C::CodecNamePropertyChanged);
    iCodecName = new PropertyString(reinterpret_cast<CpiDevice*>(aDevice)->CpStack().Stack(), "CodecName", functor);
    AddProperty(iCodecName);
    functor = MakeFunctor(*this, &CpProxyAvOpenhomeOrgInfo1C::MetatextPropertyChanged);
    iMetatext = new PropertyString(reinterpret_cast<CpiDevice*>(aDevice)->CpStack().Stack(), "Metatext", functor);

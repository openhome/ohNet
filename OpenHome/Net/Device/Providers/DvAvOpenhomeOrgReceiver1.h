...
private:
     ...
     */
    virtual void SetSender(IDvInvocation& aResponse, TUint aVersion, const Brx& aUri, const Brx& aMetadata);
    /**
     * Sender action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void Sender(IDvInvocation& aResponse, TUint aVersion, IDvInvocationResponseString& aUri, IDvInvocationResponseString& aMetadata);
    /**
     * ProtocolInfo action.
     *
     * Will be called when the device stack receives an invocation of the

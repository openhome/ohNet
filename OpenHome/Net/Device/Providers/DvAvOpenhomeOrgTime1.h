...
private:
     ...
     */
    virtual void Time(IDvInvocationResponse& aResponse, TUint aVersion, IDvInvocationResponseUint& aTrackCount, IDvInvocationResponseUint& aDuration, IDvInvocationResponseUint& aSeconds);
private:

...
private:
     ...
     */
    virtual void Time(IDvInvocation& aResponse, TUint aVersion, IDvInvocationResponseUint& aTrackCount, IDvInvocationResponseUint& aDuration, IDvInvocationResponseUint& aSeconds);
private:

...
private:
     ...
     */
    virtual void GetMediaInfo_Ext(IDvInvocationResponse& aResponse, TUint aVersion, TUint aInstanceID, IDvInvocationResponseString& aCurrentType, IDvInvocationResponseUint& aNrTracks, IDvInvocationResponseString& aMediaDuration, IDvInvocationResponseString& aCurrentURI, IDvInvocationResponseString& aCurrentURIMetaData, IDvInvocationResponseString& aNextURI, IDvInvocationResponseString& aNextURIMetaData, IDvInvocationResponseString& aPlayMedium, IDvInvocationResponseString& aRecordMedium, IDvInvocationResponseString& aWriteStatus);
    /**
     ...
     */
    virtual void GetDRMState(IDvInvocationResponse& aResponse, TUint aVersion, TUint aInstanceID, IDvInvocationResponseString& aCurrentDRMState);
    /**
     ...
     */
    virtual void SetStateVariables(IDvInvocationResponse& aResponse, TUint aVersion, TUint aInstanceID, const Brx& aAVTransportUDN, const Brx& aServiceType, const Brx& aServiceId, const Brx& aStateVariableValuePairs, IDvInvocationResponseString& aStateVariableList);
private:

...
private:
     ...
     */
    virtual void Increment(IDvInvocation& aResponse, TUint aVersion, TUint aValue, IDvInvocationResponseUint& aResult);
    /**
     * Decrement action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void Decrement(IDvInvocation& aResponse, TUint aVersion, TInt aValue, IDvInvocationResponseInt& aResult);
    /**
     * Toggle action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void Toggle(IDvInvocation& aResponse, TUint aVersion, TBool aValue, IDvInvocationResponseBool& aResult);
    /**
     * EchoString action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void EchoString(IDvInvocation& aResponse, TUint aVersion, const Brx& aValue, IDvInvocationResponseString& aResult);
    /**
     * EchoBinary action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void EchoBinary(IDvInvocation& aResponse, TUint aVersion, const Brx& aValue, IDvInvocationResponseBinary& aResult);
    /**
     * SetUint action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void SetUint(IDvInvocation& aResponse, TUint aVersion, TUint aValueUint);
    /**
     * GetUint action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void GetUint(IDvInvocation& aResponse, TUint aVersion, IDvInvocationResponseUint& aValueUint);
    /**
     * SetInt action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void SetInt(IDvInvocation& aResponse, TUint aVersion, TInt aValueInt);
    /**
     * GetInt action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void GetInt(IDvInvocation& aResponse, TUint aVersion, IDvInvocationResponseInt& aValueInt);
    /**
     * SetBool action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void SetBool(IDvInvocation& aResponse, TUint aVersion, TBool aValueBool);
    /**
     * GetBool action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void GetBool(IDvInvocation& aResponse, TUint aVersion, IDvInvocationResponseBool& aValueBool);
    /**
     * SetMultiple action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void SetMultiple(IDvInvocation& aResponse, TUint aVersion, TUint aValueUint, TInt aValueInt, TBool aValueBool);
    /**
     * SetString action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void SetString(IDvInvocation& aResponse, TUint aVersion, const Brx& aValueStr);
    /**
     * GetString action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void GetString(IDvInvocation& aResponse, TUint aVersion, IDvInvocationResponseString& aValueStr);
    /**
     * SetBinary action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void SetBinary(IDvInvocation& aResponse, TUint aVersion, const Brx& aValueBin);
    /**
     * GetBinary action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void GetBinary(IDvInvocation& aResponse, TUint aVersion, IDvInvocationResponseBinary& aValueBin);
    /**
     * ToggleBool action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void ToggleBool(IDvInvocation& aResponse, TUint aVersion);
    /**
     * WriteFile action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void WriteFile(IDvInvocation& aResponse, TUint aVersion, const Brx& aData, const Brx& aFileFullName);
    /**
     * Shutdown action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void Shutdown(IDvInvocation& aResponse, TUint aVersion);
private:

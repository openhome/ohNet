...
class TestComplianceReceiver( BASE.TestSongcastPlayback ):
    """Test Receiver service functionality compliance"""
    ...
    def Test( self, args ):
        """Check receiver service functionality compliance"""
        ...
        if len( args )>1:
            if args[1].lower() == 'local':
                ...
                argList = [args[0], args[1], 'local', 'none', 'all', 12345, 'none']
    ...
    # DS1 is receiver (DUT) , DS2 is SoftPlayer

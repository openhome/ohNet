...
kServices = {
    ...
    'Credentials':     {'ObjName':
                        ...
                        'Actions': [
                            # Action                    OutArg(s)                                   InArg(s)
                            ('Clear',                   None,                                       'id'),
                            ('Get',                     {'UserName':'string','Password':'b64',
    ...
    'Info':            {'ObjName':
                        ...
                        'Actions': [
                            # Action                    OutArg(s)                                   InArg(s)
                            ('Counters',                {'TrackCount':'uint','DetailsCount':'uint',
                                                         'MetatextCount':'uint'},                   None),
                            ('Details',                 {'Duration':'uint','BitRate':'uint',
                                                         'BitDepth':'uint','SampleRate':'uint',
                                                         'Lossless':'bool','CodecName':'string'},   None),
                            ('Metatext',                'string',                                   None),
                            ('Track',                   {'Uri':'url','Metadata':'string'},          None)]},
    'NetworkMonitor':  {'ObjName':
                        ...
                        'Actions': [
                            # Action                    OutArg(s)                                   InArg(s)
                            ('Name',                    'string',                                   None),
                            ('Ports',                   {'Sender':'uint','Receiver':'uint',
                                                         'Results':'uint'},                         None)]},
    'Playlist':        {'ObjName':
                            'playlist',
                        'Attributes': [
                        ...
                        'Actions': [
                            ...
                            ('DeleteId',                None,                                       0),
                            ('Id',                      'uint',                                     None),
                            ('IdArray',                 {'Token':'uint','Array':'b64'},             None),
    ...
    'Product':         {'ObjName':
                        ...
                        'Actions': [
                            ...
                            ('Manufacturer',            {'Name':'string','Info':'string',
                                                         'Url':'url','ImageUri':'url'},             None),
                            ('Model',                   {'Name':'string','Info':'string',
                                                         'Url':'url','ImageUri':'url'},             None),
                            ('Product',                 {'Room':'string','Name':'string',
                                                         'Info':'string','Url':'url'},              None),
                            ('SetSourceIndex',          None,                                       1),
                            ('SetSourceIndexByName',    None,                                       'Radio'),
                            ('SetStandby',              None,                                       False),
                            ('Source',                  {'SystemName':'string','Type':'string',
                                                         'Name':'string','Visible':'bool'},         1),
    ...
    'Radio':           {'ObjName':
                        ...
                        'Actions': [
                            # Action                    OutArg(s)                                   InArg(s)
                            ('Channel',                 {'Uri':'url','Metadata':'xml'},             None),
    ...
    'Time':            {'ObjName':
                        ...
                        'Actions': [
                            # Action                    OutArg(s)                                   InArg(s)
                            ('Time',                    {'TrackCount':'uint','Duration':'uint',
                                                         'Seconds':'uint'},                         None)]},
    'Volume':          {'ObjName':
                            'volume',
                        'Attributes': [
                        ...
                        'Actions': [
                            ...
                            ('Characteristics',         {'VolumeMax':'uint','VolumeUnity':'uint',
                                                         'VolumeSteps':'uint',
                                                         'VolumeMilliDbPerStep':'uint',
                                                         'BalanceMax':'uint','FadeMax':'uint'},     None),
                            ('Fade',                    'int',                                      None),
                            ('FadeDec',                 None,                                       None),
                            ('FadeInc',                 None,                                       None),
                            ('Mute',                    'bool',                                     None),

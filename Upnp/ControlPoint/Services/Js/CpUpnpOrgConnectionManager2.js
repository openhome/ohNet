...
/**
* Service Proxy for schemas-upnp-org:ConnectionManager:2
* @module Zapp
...
var CpProxySchemasUpnpOrgConnectionManager2 = function(udn){	
	...
	this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/schemas-upnp-org-ConnectionManager-2/control";  // upnp control url
	this.domain = "schemas-upnp-org";
	this.type = "ConnectionManager";
	this.version = "2";
	this.serviceName = "CpProxySchemasUpnpOrgConnectionManager2";

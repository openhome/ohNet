...
var ServiceAVTransport = function(aUdn){	
	this.iUrl = window.location.protocol + "//" + window.location.host + "/" + aUdn + "/upnp.org-AVTransport-2/control";
	...
	this.iVersion = "2";
	this.iServiceName = "upnp.org-AVTransport-2";
...
ServiceAVTransport.prototype.CurrentMediaCategory_Changed = function (aStateChangedFunction) {
    this.Variables().CurrentMediaCategory.AddListener(function (state) 
	{ 
		aStateChangedFunction(SoapRequest.ReadStringParameter(state)); 
	});
}
...
ServiceAVTransport.prototype.DRMState_Changed = function (aStateChangedFunction) {
    this.Variables().DRMState.AddListener(function (state) 
	{ 
		aStateChangedFunction(SoapRequest.ReadStringParameter(state)); 
	});
}
...
ServiceAVTransport.prototype.DeviceUDN_Changed = function (aStateChangedFunction) {
    this.Variables().DeviceUDN.AddListener(function (state) 
	{ 
		aStateChangedFunction(SoapRequest.ReadStringParameter(state)); 
	});
}
ServiceAVTransport.prototype.ServiceType_Changed = function (aStateChangedFunction) {
    this.Variables().ServiceType.AddListener(function (state) 
	{ 
		aStateChangedFunction(SoapRequest.ReadStringParameter(state)); 
	});
}
ServiceAVTransport.prototype.ServiceID_Changed = function (aStateChangedFunction) {
    this.Variables().ServiceID.AddListener(function (state) 
	{ 
		aStateChangedFunction(SoapRequest.ReadStringParameter(state)); 
	});
}
ServiceAVTransport.prototype.StateVariableValuePairs_Changed = function (aStateChangedFunction) {
    this.Variables().StateVariableValuePairs.AddListener(function (state) 
	{ 
		aStateChangedFunction(SoapRequest.ReadStringParameter(state)); 
	});
}
ServiceAVTransport.prototype.StateVariableList_Changed = function (aStateChangedFunction) {
...
ServiceAVTransport.prototype.GetMediaInfo_Ext = function(InstanceID, aSuccessFunction, aErrorFunction){	
    ...
    request.WriteIntParameter("InstanceID", InstanceID);
    request.Send(function(result){
		result["CurrentType"] = SoapRequest.ReadStringParameter(result["CurrentType"]);	
		result["NrTracks"] = SoapRequest.ReadIntParameter(result["NrTracks"]);	
		result["MediaDuration"] = SoapRequest.ReadStringParameter(result["MediaDuration"]);	
		result["CurrentURI"] = SoapRequest.ReadStringParameter(result["CurrentURI"]);	
		result["CurrentURIMetaData"] = SoapRequest.ReadStringParameter(result["CurrentURIMetaData"]);	
...
ServiceAVTransport.prototype.GetDRMState = function(InstanceID, aSuccessFunction, aErrorFunction){	
    ...
    request.WriteIntParameter("InstanceID", InstanceID);
    request.Send(function(result){
		result["CurrentDRMState"] = SoapRequest.ReadStringParameter(result["CurrentDRMState"]);	

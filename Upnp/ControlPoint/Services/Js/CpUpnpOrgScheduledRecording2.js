...
/**
* Service Proxy for schemas-upnp-org:ScheduledRecording:2
* @module Zapp
...
var CpProxySchemasUpnpOrgScheduledRecording2 = function(udn){	
	...
	this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/schemas-upnp-org-ScheduledRecording-2/control";  // upnp control url
	this.domain = "schemas-upnp-org";
	this.type = "ScheduledRecording";
	this.version = "2";
	this.serviceName = "CpProxySchemasUpnpOrgScheduledRecording2";

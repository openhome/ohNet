...
/**
* Service Proxy for schemas-upnp-org:ContentDirectory:3
* @module Zapp
...
var CpProxySchemasUpnpOrgContentDirectory3 = function(udn){	
	...
	this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/schemas-upnp-org-ContentDirectory-3/control";  // upnp control url
	this.domain = "schemas-upnp-org";
	this.type = "ContentDirectory";
	this.version = "3";
	this.serviceName = "CpProxySchemasUpnpOrgContentDirectory3";

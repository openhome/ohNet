...
namespace Zapp.ControlPoint.Proxies
{
    ...
    public class CpProxyZappOrgTestWidgetController1 : CpProxy, IDisposable, ICpProxyZappOrgTestWidgetController1
    {
        ...
        static extern IntPtr CpProxyZappOrgTestWidgetController1Create(IntPtr aDeviceHandle);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern void CpProxyZappOrgTestWidgetController1Destroy(IntPtr aHandle);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern unsafe void CpProxyZappOrgTestWidgetController1SyncCreateWidget(IntPtr aHandle, char* aWidgetUdn, uint aWidgetClass);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern unsafe void CpProxyZappOrgTestWidgetController1BeginCreateWidget(IntPtr aHandle, char* aWidgetUdn, uint aWidgetClass, CallbackActionComplete aCallback, IntPtr aPtr);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern unsafe int CpProxyZappOrgTestWidgetController1EndCreateWidget(IntPtr aHandle, IntPtr aAsync);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern unsafe void CpProxyZappOrgTestWidgetController1SyncRemoveWidget(IntPtr aHandle, char* aWidgetUdn);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern unsafe void CpProxyZappOrgTestWidgetController1BeginRemoveWidget(IntPtr aHandle, char* aWidgetUdn, CallbackActionComplete aCallback, IntPtr aPtr);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern unsafe int CpProxyZappOrgTestWidgetController1EndRemoveWidget(IntPtr aHandle, IntPtr aAsync);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern unsafe void CpProxyZappOrgTestWidgetController1SyncSetWidgetRegister(IntPtr aHandle, char* aWidgetUdn, uint aRegisterIndex, uint aRegisterValue);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern unsafe void CpProxyZappOrgTestWidgetController1BeginSetWidgetRegister(IntPtr aHandle, char* aWidgetUdn, uint aRegisterIndex, uint aRegisterValue, CallbackActionComplete aCallback, IntPtr aPtr);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern unsafe int CpProxyZappOrgTestWidgetController1EndSetWidgetRegister(IntPtr aHandle, IntPtr aAsync);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern unsafe void CpProxyZappOrgTestWidgetController1SyncGetWidgetRegister(IntPtr aHandle, char* aWidgetUdn, uint aRegisterIndex, uint* aRegisterValue);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern unsafe void CpProxyZappOrgTestWidgetController1BeginGetWidgetRegister(IntPtr aHandle, char* aWidgetUdn, uint aRegisterIndex, CallbackActionComplete aCallback, IntPtr aPtr);
        [DllImport("CpZappOrgTestWidgetController1")]
        static extern unsafe int CpProxyZappOrgTestWidgetController1EndGetWidgetRegister(IntPtr aHandle, IntPtr aAsync, uint* aRegisterValue);
        [DllImport("ZappUpnp")]
        ...
        public unsafe void EndCreateWidget(IntPtr aAsyncHandle)
        {
            {
        ...
        /// <remarks>This may only be called from the callback set in the above Begin function.</remarks>
        /// <param name="aAsyncHandle">Argument passed to the delegate set in the above Begin function</param>
        public unsafe void EndRemoveWidget(IntPtr aAsyncHandle)
        {
            {
        ...
        /// <remarks>This may only be called from the callback set in the above Begin function.</remarks>
        /// <param name="aAsyncHandle">Argument passed to the delegate set in the above Begin function</param>
        public unsafe void EndSetWidgetRegister(IntPtr aAsyncHandle)
        {
            {
        ...
        /// <param name="aAsyncHandle">Argument passed to the delegate set in the above Begin function</param>
        /// <param name="aRegisterValue"></param>
        public unsafe void EndGetWidgetRegister(IntPtr aAsyncHandle, out uint aRegisterValue)
        {
            fixed (uint* registerValue = &aRegisterValue)
            {

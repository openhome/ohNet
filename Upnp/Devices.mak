...
DvUpnpOrgAVTransport1Dll: ZappUpnpDll $(objdir)DvUpnpOrgAVTransport1C.$(objext) $(objdir)DvUpnpOrgAVTransport1.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgAVTransport1.$(dllext) $(objdir)DvUpnpOrgAVTransport1C.$(objext) $(objdir)DvUpnpOrgAVTransport1.$(objext)
DvUpnpOrgAVTransport2Dll: ZappUpnpDll $(objdir)DvUpnpOrgAVTransport2C.$(objext) $(objdir)DvUpnpOrgAVTransport2.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgAVTransport2.$(dllext) $(objdir)DvUpnpOrgAVTransport2C.$(objext) $(objdir)DvUpnpOrgAVTransport2.$(objext)
DvUpnpOrgConnectionManager1Dll: ZappUpnpDll $(objdir)DvUpnpOrgConnectionManager1C.$(objext) $(objdir)DvUpnpOrgConnectionManager1.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgConnectionManager1.$(dllext) $(objdir)DvUpnpOrgConnectionManager1C.$(objext) $(objdir)DvUpnpOrgConnectionManager1.$(objext)
DvUpnpOrgConnectionManager2Dll: ZappUpnpDll $(objdir)DvUpnpOrgConnectionManager2C.$(objext) $(objdir)DvUpnpOrgConnectionManager2.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgConnectionManager2.$(dllext) $(objdir)DvUpnpOrgConnectionManager2C.$(objext) $(objdir)DvUpnpOrgConnectionManager2.$(objext)
DvUpnpOrgContentDirectory1Dll: ZappUpnpDll $(objdir)DvUpnpOrgContentDirectory1C.$(objext) $(objdir)DvUpnpOrgContentDirectory1.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgContentDirectory1.$(dllext) $(objdir)DvUpnpOrgContentDirectory1C.$(objext) $(objdir)DvUpnpOrgContentDirectory1.$(objext)
DvUpnpOrgContentDirectory2Dll: ZappUpnpDll $(objdir)DvUpnpOrgContentDirectory2C.$(objext) $(objdir)DvUpnpOrgContentDirectory2.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgContentDirectory2.$(dllext) $(objdir)DvUpnpOrgContentDirectory2C.$(objext) $(objdir)DvUpnpOrgContentDirectory2.$(objext)
DvUpnpOrgContentDirectory3Dll: ZappUpnpDll $(objdir)DvUpnpOrgContentDirectory3C.$(objext) $(objdir)DvUpnpOrgContentDirectory3.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgContentDirectory3.$(dllext) $(objdir)DvUpnpOrgContentDirectory3C.$(objext) $(objdir)DvUpnpOrgContentDirectory3.$(objext)
DvUpnpOrgRenderingControl1Dll: ZappUpnpDll $(objdir)DvUpnpOrgRenderingControl1C.$(objext) $(objdir)DvUpnpOrgRenderingControl1.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgRenderingControl1.$(dllext) $(objdir)DvUpnpOrgRenderingControl1C.$(objext) $(objdir)DvUpnpOrgRenderingControl1.$(objext)
DvUpnpOrgRenderingControl2Dll: ZappUpnpDll $(objdir)DvUpnpOrgRenderingControl2C.$(objext) $(objdir)DvUpnpOrgRenderingControl2.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgRenderingControl2.$(dllext) $(objdir)DvUpnpOrgRenderingControl2C.$(objext) $(objdir)DvUpnpOrgRenderingControl2.$(objext)
DvUpnpOrgScheduledRecording1Dll: ZappUpnpDll $(objdir)DvUpnpOrgScheduledRecording1C.$(objext) $(objdir)DvUpnpOrgScheduledRecording1.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgScheduledRecording1.$(dllext) $(objdir)DvUpnpOrgScheduledRecording1C.$(objext) $(objdir)DvUpnpOrgScheduledRecording1.$(objext)
DvUpnpOrgScheduledRecording2Dll: ZappUpnpDll $(objdir)DvUpnpOrgScheduledRecording2C.$(objext) $(objdir)DvUpnpOrgScheduledRecording2.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgScheduledRecording2.$(dllext) $(objdir)DvUpnpOrgScheduledRecording2C.$(objext) $(objdir)DvUpnpOrgScheduledRecording2.$(objext)
DvUpnpOrgSwitchPower1Dll: ZappUpnpDll $(objdir)DvUpnpOrgSwitchPower1C.$(objext) $(objdir)DvUpnpOrgSwitchPower1.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgSwitchPower1.$(dllext) $(objdir)DvUpnpOrgSwitchPower1C.$(objext) $(objdir)DvUpnpOrgSwitchPower1.$(objext)
DvUpnpOrgDimming1Dll: ZappUpnpDll $(objdir)DvUpnpOrgDimming1C.$(objext) $(objdir)DvUpnpOrgDimming1.$(objext)
	$(linker_dll_service)$(dllprefix)DvUpnpOrgDimming1.$(dllext) $(objdir)DvUpnpOrgDimming1C.$(objext) $(objdir)DvUpnpOrgDimming1.$(objext)
DvLinnCoUkComponent1Dll: ZappUpnpDll $(objdir)DvLinnCoUkComponent1C.$(objext) $(objdir)DvLinnCoUkComponent1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkComponent1.$(dllext) $(objdir)DvLinnCoUkComponent1C.$(objext) $(objdir)DvLinnCoUkComponent1.$(objext)
DvLinnCoUkConfiguration1Dll: ZappUpnpDll $(objdir)DvLinnCoUkConfiguration1C.$(objext) $(objdir)DvLinnCoUkConfiguration1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkConfiguration1.$(dllext) $(objdir)DvLinnCoUkConfiguration1C.$(objext) $(objdir)DvLinnCoUkConfiguration1.$(objext)
DvLinnCoUkDebug2Dll: ZappUpnpDll $(objdir)DvLinnCoUkDebug2C.$(objext) $(objdir)DvLinnCoUkDebug2.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkDebug2.$(dllext) $(objdir)DvLinnCoUkDebug2C.$(objext) $(objdir)DvLinnCoUkDebug2.$(objext)
DvLinnCoUkDelay1Dll: ZappUpnpDll $(objdir)DvLinnCoUkDelay1C.$(objext) $(objdir)DvLinnCoUkDelay1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkDelay1.$(dllext) $(objdir)DvLinnCoUkDelay1C.$(objext) $(objdir)DvLinnCoUkDelay1.$(objext)
DvLinnCoUkDiagnostics1Dll: ZappUpnpDll $(objdir)DvLinnCoUkDiagnostics1C.$(objext) $(objdir)DvLinnCoUkDiagnostics1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkDiagnostics1.$(dllext) $(objdir)DvLinnCoUkDiagnostics1C.$(objext) $(objdir)DvLinnCoUkDiagnostics1.$(objext)
DvLinnCoUkDs1Dll: ZappUpnpDll $(objdir)DvLinnCoUkDs1C.$(objext) $(objdir)DvLinnCoUkDs1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkDs1.$(dllext) $(objdir)DvLinnCoUkDs1C.$(objext) $(objdir)DvLinnCoUkDs1.$(objext)
DvLinnCoUkInfo1Dll: ZappUpnpDll $(objdir)DvLinnCoUkInfo1C.$(objext) $(objdir)DvLinnCoUkInfo1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkInfo1.$(dllext) $(objdir)DvLinnCoUkInfo1C.$(objext) $(objdir)DvLinnCoUkInfo1.$(objext)
DvLinnCoUkJukebox1Dll: ZappUpnpDll $(objdir)DvLinnCoUkJukebox1C.$(objext) $(objdir)DvLinnCoUkJukebox1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkJukebox1.$(dllext) $(objdir)DvLinnCoUkJukebox1C.$(objext) $(objdir)DvLinnCoUkJukebox1.$(objext)
DvLinnCoUkMediaTime1Dll: ZappUpnpDll $(objdir)DvLinnCoUkMediaTime1C.$(objext) $(objdir)DvLinnCoUkMediaTime1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkMediaTime1.$(dllext) $(objdir)DvLinnCoUkMediaTime1C.$(objext) $(objdir)DvLinnCoUkMediaTime1.$(objext)
DvLinnCoUkPlaylist1Dll: ZappUpnpDll $(objdir)DvLinnCoUkPlaylist1C.$(objext) $(objdir)DvLinnCoUkPlaylist1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkPlaylist1.$(dllext) $(objdir)DvLinnCoUkPlaylist1C.$(objext) $(objdir)DvLinnCoUkPlaylist1.$(objext)
DvLinnCoUkPreamp4Dll: ZappUpnpDll $(objdir)DvLinnCoUkPreamp4C.$(objext) $(objdir)DvLinnCoUkPreamp4.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkPreamp4.$(dllext) $(objdir)DvLinnCoUkPreamp4C.$(objext) $(objdir)DvLinnCoUkPreamp4.$(objext)
DvLinnCoUkProduct1Dll: ZappUpnpDll $(objdir)DvLinnCoUkProduct1C.$(objext) $(objdir)DvLinnCoUkProduct1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkProduct1.$(dllext) $(objdir)DvLinnCoUkProduct1C.$(objext) $(objdir)DvLinnCoUkProduct1.$(objext)
DvLinnCoUkProduct2Dll: ZappUpnpDll $(objdir)DvLinnCoUkProduct2C.$(objext) $(objdir)DvLinnCoUkProduct2.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkProduct2.$(dllext) $(objdir)DvLinnCoUkProduct2C.$(objext) $(objdir)DvLinnCoUkProduct2.$(objext)
DvLinnCoUkProduct3Dll: ZappUpnpDll $(objdir)DvLinnCoUkProduct3C.$(objext) $(objdir)DvLinnCoUkProduct3.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkProduct3.$(dllext) $(objdir)DvLinnCoUkProduct3C.$(objext) $(objdir)DvLinnCoUkProduct3.$(objext)
DvLinnCoUkProxyManager1Dll: ZappUpnpDll $(objdir)DvLinnCoUkProxyManager1C.$(objext) $(objdir)DvLinnCoUkProxyManager1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkProxyManager1.$(dllext) $(objdir)DvLinnCoUkProxyManager1C.$(objext) $(objdir)DvLinnCoUkProxyManager1.$(objext)
DvLinnCoUkPtest1Dll: ZappUpnpDll $(objdir)DvLinnCoUkPtest1C.$(objext) $(objdir)DvLinnCoUkPtest1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkPtest1.$(dllext) $(objdir)DvLinnCoUkPtest1C.$(objext) $(objdir)DvLinnCoUkPtest1.$(objext)
DvLinnCoUkRadio1Dll: ZappUpnpDll $(objdir)DvLinnCoUkRadio1C.$(objext) $(objdir)DvLinnCoUkRadio1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkRadio1.$(dllext) $(objdir)DvLinnCoUkRadio1C.$(objext) $(objdir)DvLinnCoUkRadio1.$(objext)
DvLinnCoUkTime1Dll: ZappUpnpDll $(objdir)DvLinnCoUkTime1C.$(objext) $(objdir)DvLinnCoUkTime1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkTime1.$(dllext) $(objdir)DvLinnCoUkTime1C.$(objext) $(objdir)DvLinnCoUkTime1.$(objext)
DvLinnCoUkUi2Dll: ZappUpnpDll $(objdir)DvLinnCoUkUi2C.$(objext) $(objdir)DvLinnCoUkUi2.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkUi2.$(dllext) $(objdir)DvLinnCoUkUi2C.$(objext) $(objdir)DvLinnCoUkUi2.$(objext)
DvLinnCoUkVolkano1Dll: ZappUpnpDll $(objdir)DvLinnCoUkVolkano1C.$(objext) $(objdir)DvLinnCoUkVolkano1.$(objext)
	$(linker_dll_service)$(dllprefix)DvLinnCoUkVolkano1.$(dllext) $(objdir)DvLinnCoUkVolkano1C.$(objext) $(objdir)DvLinnCoUkVolkano1.$(objext)
DvZappOrgTestBasic1Dll: ZappUpnpDll $(objdir)DvZappOrgTestBasic1C.$(objext) $(objdir)DvZappOrgTestBasic1.$(objext)
	$(linker_dll_service)$(dllprefix)DvZappOrgTestBasic1.$(dllext) $(objdir)DvZappOrgTestBasic1C.$(objext) $(objdir)DvZappOrgTestBasic1.$(objext)
DvZappOrgTestLights1Dll: ZappUpnpDll $(objdir)DvZappOrgTestLights1C.$(objext) $(objdir)DvZappOrgTestLights1.$(objext)
	$(linker_dll_service)$(dllprefix)DvZappOrgTestLights1.$(dllext) $(objdir)DvZappOrgTestLights1C.$(objext) $(objdir)DvZappOrgTestLights1.$(objext)
DvZappOrgTestDimmableLight1Dll: ZappUpnpDll $(objdir)DvZappOrgTestDimmableLight1C.$(objext) $(objdir)DvZappOrgTestDimmableLight1.$(objext)
	$(linker_dll_service)$(dllprefix)DvZappOrgTestDimmableLight1.$(dllext) $(objdir)DvZappOrgTestDimmableLight1C.$(objext) $(objdir)DvZappOrgTestDimmableLight1.$(objext)

...
void DvProviderUpnpOrgConnectionManager2Cpp::EnableActionGetProtocolInfo()
{
    ...
    FunctorDvInvocation functor = MakeFunctorDvInvocation(*this, &DvProviderUpnpOrgConnectionManager2Cpp::DoGetProtocolInfo);
...
void DvProviderUpnpOrgConnectionManager2Cpp::EnableActionPrepareForConnection()
{
    ...
    FunctorDvInvocation functor = MakeFunctorDvInvocation(*this, &DvProviderUpnpOrgConnectionManager2Cpp::DoPrepareForConnection);
    iService->AddAction(action, functor);
}
...
void DvProviderUpnpOrgConnectionManager2Cpp::EnableActionConnectionComplete()
{
    ...
    FunctorDvInvocation functor = MakeFunctorDvInvocation(*this, &DvProviderUpnpOrgConnectionManager2Cpp::DoConnectionComplete);
    iService->AddAction(action, functor);
}
...
void DvProviderUpnpOrgConnectionManager2Cpp::EnableActionGetCurrentConnectionIDs()
{
    ...
    FunctorDvInvocation functor = MakeFunctorDvInvocation(*this, &DvProviderUpnpOrgConnectionManager2Cpp::DoGetCurrentConnectionIDs);
    iService->AddAction(action, functor);
}
...
void DvProviderUpnpOrgConnectionManager2Cpp::EnableActionGetCurrentConnectionInfo()
{
    ...
    delete[] allowedValues;
    FunctorDvInvocation functor = MakeFunctorDvInvocation(*this, &DvProviderUpnpOrgConnectionManager2Cpp::DoGetCurrentConnectionInfo);
    iService->AddAction(action, functor);
}

void DvProviderUpnpOrgConnectionManager2Cpp::DoGetProtocolInfo(IDvInvocation& aInvocation, TUint aVersion)
{
...
void DvProviderUpnpOrgConnectionManager2Cpp::DoPrepareForConnection(IDvInvocation& aInvocation, TUint aVersion)
{
    aInvocation.InvocationReadStart();
...
void DvProviderUpnpOrgConnectionManager2Cpp::DoConnectionComplete(IDvInvocation& aInvocation, TUint aVersion)
{
    aInvocation.InvocationReadStart();
...
void DvProviderUpnpOrgConnectionManager2Cpp::DoGetCurrentConnectionIDs(IDvInvocation& aInvocation, TUint aVersion)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderUpnpOrgConnectionManager2Cpp::DoGetCurrentConnectionInfo(IDvInvocation& aInvocation, TUint aVersion)
{
    aInvocation.InvocationReadStart();
    int32_t ConnectionID = aInvocation.InvocationReadInt("ConnectionID");
    aInvocation.InvocationReadEnd();
...
void DvProviderUpnpOrgConnectionManager2Cpp::GetProtocolInfo(uint32_t /*aVersion*/, std::string& /*aSource*/, std::string& /*aSink*/)
{
    ASSERTS();
}

void DvProviderUpnpOrgConnectionManager2Cpp::PrepareForConnection(uint32_t /*aVersion*/, const std::string& /*aRemoteProtocolInfo*/, const std::string& /*aPeerConnectionManager*/, int32_t /*aPeerConnectionID*/, const std::string& /*aDirection*/, int32_t& /*aConnectionID*/, int32_t& /*aAVTransportID*/, int32_t& /*aRcsID*/)
{
    ASSERTS();
}

void DvProviderUpnpOrgConnectionManager2Cpp::ConnectionComplete(uint32_t /*aVersion*/, int32_t /*aConnectionID*/)
{
    ASSERTS();
}

void DvProviderUpnpOrgConnectionManager2Cpp::GetCurrentConnectionIDs(uint32_t /*aVersion*/, std::string& /*aConnectionIDs*/)
{
    ASSERTS();
}

void DvProviderUpnpOrgConnectionManager2Cpp::GetCurrentConnectionInfo(uint32_t /*aVersion*/, int32_t /*aConnectionID*/, int32_t& /*aRcsID*/, int32_t& /*aAVTransportID*/, std::string& /*aProtocolInfo*/, std::string& /*aPeerConnectionManager*/, int32_t& /*aPeerConnectionID*/, std::string& /*aDirection*/, std::string& /*aStatus*/)
{
    ASSERTS();
}

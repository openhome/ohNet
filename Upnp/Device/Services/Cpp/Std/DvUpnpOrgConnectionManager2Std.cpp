#include <Std/DvUpnpOrgConnectionManager2.h>
#include <ZappTypes.h>
...
DvServiceUpnpOrgConnectionManager2Cpp::DvServiceUpnpOrgConnectionManager2Cpp(DvDeviceStd& aDevice)
...
void DvServiceUpnpOrgConnectionManager2Cpp::EnableActionGetProtocolInfo()
{
    ...
    FunctorDvInvocation functor = MakeFunctorDvInvocation(*this, &DvServiceUpnpOrgConnectionManager2Cpp::DoGetProtocolInfo);
    iService->AddAction(action, functor);
}

void DvServiceUpnpOrgConnectionManager2Cpp::EnableActionPrepareForConnection()
{
    ...
    FunctorDvInvocation functor = MakeFunctorDvInvocation(*this, &DvServiceUpnpOrgConnectionManager2Cpp::DoPrepareForConnection);
    iService->AddAction(action, functor);
}

void DvServiceUpnpOrgConnectionManager2Cpp::EnableActionConnectionComplete()
{
    Zapp::Action* action = new Zapp::Action("ConnectionComplete");
    action->AddInputParameter(new ParameterInt("ConnectionID"));
    FunctorDvInvocation functor = MakeFunctorDvInvocation(*this, &DvServiceUpnpOrgConnectionManager2Cpp::DoConnectionComplete);
    iService->AddAction(action, functor);
}

void DvServiceUpnpOrgConnectionManager2Cpp::EnableActionGetCurrentConnectionIDs()
{
    ...
    FunctorDvInvocation functor = MakeFunctorDvInvocation(*this, &DvServiceUpnpOrgConnectionManager2Cpp::DoGetCurrentConnectionIDs);
    iService->AddAction(action, functor);
}

void DvServiceUpnpOrgConnectionManager2Cpp::EnableActionGetCurrentConnectionInfo()
{
    ...
    delete[] allowedValues;
    FunctorDvInvocation functor = MakeFunctorDvInvocation(*this, &DvServiceUpnpOrgConnectionManager2Cpp::DoGetCurrentConnectionInfo);
    iService->AddAction(action, functor);
}

void DvServiceUpnpOrgConnectionManager2Cpp::DoGetProtocolInfo(IDvInvocation& aInvocation, TUint aVersion)
{
...
void DvServiceUpnpOrgConnectionManager2Cpp::DoPrepareForConnection(IDvInvocation& aInvocation, TUint aVersion)
{
    aInvocation.InvocationReadStart();
...
void DvServiceUpnpOrgConnectionManager2Cpp::DoConnectionComplete(IDvInvocation& aInvocation, TUint aVersion)
{
    aInvocation.InvocationReadStart();
...
void DvServiceUpnpOrgConnectionManager2Cpp::DoGetCurrentConnectionIDs(IDvInvocation& aInvocation, TUint aVersion)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvServiceUpnpOrgConnectionManager2Cpp::DoGetCurrentConnectionInfo(IDvInvocation& aInvocation, TUint aVersion)
{
    aInvocation.InvocationReadStart();
    int32_t ConnectionID = aInvocation.InvocationReadInt("ConnectionID");
    aInvocation.InvocationReadEnd();
...
void DvServiceUpnpOrgConnectionManager2Cpp::GetProtocolInfo(uint32_t /*aVersion*/, std::string& /*aSource*/, std::string& /*aSink*/)
{
    ASSERTS();
}

void DvServiceUpnpOrgConnectionManager2Cpp::PrepareForConnection(uint32_t /*aVersion*/, const std::string& /*aRemoteProtocolInfo*/, const std::string& /*aPeerConnectionManager*/, int32_t /*aPeerConnectionID*/, const std::string& /*aDirection*/, int32_t& /*aConnectionID*/, int32_t& /*aAVTransportID*/, int32_t& /*aRcsID*/)
{
    ASSERTS();
}

void DvServiceUpnpOrgConnectionManager2Cpp::ConnectionComplete(uint32_t /*aVersion*/, int32_t /*aConnectionID*/)
{
    ASSERTS();
}

void DvServiceUpnpOrgConnectionManager2Cpp::GetCurrentConnectionIDs(uint32_t /*aVersion*/, std::string& /*aConnectionIDs*/)
{
    ASSERTS();
}

void DvServiceUpnpOrgConnectionManager2Cpp::GetCurrentConnectionInfo(uint32_t /*aVersion*/, int32_t /*aConnectionID*/, int32_t& /*aRcsID*/, int32_t& /*aAVTransportID*/, std::string& /*aProtocolInfo*/, std::string& /*aPeerConnectionManager*/, int32_t& /*aPeerConnectionID*/, std::string& /*aDirection*/, std::string& /*aStatus*/)
{
    ASSERTS();
}

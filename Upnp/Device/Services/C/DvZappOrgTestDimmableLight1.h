 ...
 *
 * @param[in]  aPtr      Opaque data passed to DvProviderZappOrgTestDimmableLight1EnableActionSetLevel
 * @param[in]  aVersion  Version of the service being used.  Will be <= the version advertised by the provider
 * @param[in]  aLevel
 *
 * @return  0 if the action succeeded; non-zero if the action failed
 ...
 * Provider destructor
 *
 * @param[in] aProvider  Handle returned by DvProviderZappOrgTestDimmableLight1Create
 */

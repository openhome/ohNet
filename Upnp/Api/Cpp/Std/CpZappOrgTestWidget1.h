#ifndef HEADER_ZAPPORGTESTWIDGET1CPP
#define HEADER_ZAPPORGTESTWIDGET1CPP
 ...
 * @ingroup Proxies
 */
class CpProxyZappOrgTestWidget1Cpp : public CpProxy
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyZappOrgTestWidget1Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    void SyncSetReadWriteRegister(uint32_t aRegisterIndex, uint32_t aRegisterValue);
    /**
     ...
     */
    void BeginSetReadWriteRegister(uint32_t aRegisterIndex, uint32_t aRegisterValue, FunctorAsync& aFunctor);
    /**
     ...
     * CpProxyZappOrgTestWidget1Cpp instance will not overlap.
     *
     ...
     */
    void PropertyReadWriteRegister0(uint32_t& aReadWriteRegister0) const;
    /**
     ...
     */
    void PropertyReadWriteRegister1(uint32_t& aReadWriteRegister1) const;
    /**
     ...
     */
    void PropertyReadWriteRegister2(uint32_t& aReadWriteRegister2) const;
    /**
     ...
     */
    void PropertyReadWriteRegister3(uint32_t& aReadWriteRegister3) const;
    /**
     ...
     */
    void PropertyReadOnlyRegister4(uint32_t& aReadOnlyRegister4) const;
    /**
     ...
     */
    void PropertyReadOnlyRegister5(uint32_t& aReadOnlyRegister5) const;
    /**
     ...
     */
    void PropertyReadOnlyRegister6(uint32_t& aReadOnlyRegister6) const;
    /**
     ...
     */
    void PropertyReadOnlyRegister7(uint32_t& aReadOnlyRegister7) const;
private:
...
#endif // HEADER_ZAPPORGTESTWIDGET1CPP

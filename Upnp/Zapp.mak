...
linker = link /nologo /debug /SUBSYSTEM:CONSOLE /map Ws2_32.lib Iphlpapi.lib /out:$(objdir)
dllprefix =
dllext = dll
linker_dll = link /nologo /debug /map Ws2_32.lib Iphlpapi.lib /dll /out:$(objdir)
linker_dll_service = link /nologo /debug /map $(objdir)ZappUpnp.lib Ws2_32.lib Iphlpapi.lib /dll /out:$(objdir)

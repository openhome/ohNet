...
objects_devices = \
                  ...
                  $(objdir)DvLinnCoUkComponent1.$(objext) \
                  $(objdir)DvLinnCoUkComponent1Std.$(objext) \
                  $(objdir)DvLinnCoUkComponent1C.$(objext) \
                  $(objdir)DvLinnCoUkConfiguration1.$(objext) \
                  $(objdir)DvLinnCoUkConfiguration1Std.$(objext) \
                  $(objdir)DvLinnCoUkConfiguration1C.$(objext) \
                  $(objdir)DvLinnCoUkDebug2.$(objext) \
                  $(objdir)DvLinnCoUkDebug2Std.$(objext) \
                  $(objdir)DvLinnCoUkDebug2C.$(objext) \
                  $(objdir)DvLinnCoUkDelay1.$(objext) \
                  $(objdir)DvLinnCoUkDelay1Std.$(objext) \
                  $(objdir)DvLinnCoUkDelay1C.$(objext) \
                  $(objdir)DvLinnCoUkDiagnostics1.$(objext) \
                  $(objdir)DvLinnCoUkDiagnostics1Std.$(objext) \
                  $(objdir)DvLinnCoUkDiagnostics1C.$(objext) \
                  $(objdir)DvLinnCoUkDs1.$(objext) \
                  $(objdir)DvLinnCoUkDs1Std.$(objext) \
                  $(objdir)DvLinnCoUkDs1C.$(objext) \
                  $(objdir)DvLinnCoUkInfo1.$(objext) \
                  $(objdir)DvLinnCoUkInfo1Std.$(objext) \
                  $(objdir)DvLinnCoUkInfo1C.$(objext) \
                  $(objdir)DvLinnCoUkJukebox1.$(objext) \
                  $(objdir)DvLinnCoUkJukebox1Std.$(objext) \
                  $(objdir)DvLinnCoUkJukebox1C.$(objext) \
                  $(objdir)DvLinnCoUkMediaTime1.$(objext) \
                  $(objdir)DvLinnCoUkMediaTime1Std.$(objext) \
                  $(objdir)DvLinnCoUkMediaTime1C.$(objext) \
                  $(objdir)DvLinnCoUkPlaylist1.$(objext) \
                  $(objdir)DvLinnCoUkPlaylist1Std.$(objext) \
                  $(objdir)DvLinnCoUkPlaylist1C.$(objext) \
                  $(objdir)DvLinnCoUkPreamp4.$(objext) \
                  $(objdir)DvLinnCoUkPreamp4Std.$(objext) \
                  $(objdir)DvLinnCoUkPreamp4C.$(objext) \
                  $(objdir)DvLinnCoUkProduct1.$(objext) \
                  $(objdir)DvLinnCoUkProduct1Std.$(objext) \
                  $(objdir)DvLinnCoUkProduct1C.$(objext) \
                  $(objdir)DvLinnCoUkProduct2.$(objext) \
                  $(objdir)DvLinnCoUkProduct2Std.$(objext) \
                  $(objdir)DvLinnCoUkProduct2C.$(objext) \
                  $(objdir)DvLinnCoUkProduct3.$(objext) \
                  $(objdir)DvLinnCoUkProduct3Std.$(objext) \
                  $(objdir)DvLinnCoUkProduct3C.$(objext) \
                  $(objdir)DvLinnCoUkProxyManager1.$(objext) \
                  $(objdir)DvLinnCoUkProxyManager1Std.$(objext) \
                  $(objdir)DvLinnCoUkProxyManager1C.$(objext) \
                  $(objdir)DvLinnCoUkPtest1.$(objext) \
                  $(objdir)DvLinnCoUkPtest1Std.$(objext) \
                  $(objdir)DvLinnCoUkPtest1C.$(objext) \
                  $(objdir)DvLinnCoUkRadio1.$(objext) \
                  $(objdir)DvLinnCoUkRadio1Std.$(objext) \
                  $(objdir)DvLinnCoUkRadio1C.$(objext) \
                  $(objdir)DvLinnCoUkTime1.$(objext) \
                  $(objdir)DvLinnCoUkTime1Std.$(objext) \
                  $(objdir)DvLinnCoUkTime1C.$(objext) \
                  $(objdir)DvLinnCoUkUi2.$(objext) \
                  $(objdir)DvLinnCoUkUi2Std.$(objext) \
                  $(objdir)DvLinnCoUkUi2C.$(objext) \
...
device_dlls = \
             ...
             DvLinnCoUkComponent1Dll \
             DvLinnCoUkConfiguration1Dll \
             DvLinnCoUkDebug2Dll \
             DvLinnCoUkDelay1Dll \
             DvLinnCoUkDiagnostics1Dll \
             DvLinnCoUkDs1Dll \
             DvLinnCoUkInfo1Dll \
             DvLinnCoUkJukebox1Dll \
             DvLinnCoUkMediaTime1Dll \
             DvLinnCoUkPlaylist1Dll \
             DvLinnCoUkPreamp4Dll \
             DvLinnCoUkProduct1Dll \
             DvLinnCoUkProduct2Dll \
             DvLinnCoUkProduct3Dll \
             DvLinnCoUkProxyManager1Dll \
             DvLinnCoUkPtest1Dll \
             DvLinnCoUkRadio1Dll \
             DvLinnCoUkTime1Dll \
             DvLinnCoUkUi2Dll \
...
$(objdir)$(dllprefix)DvUpnpOrgAVTransport1.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgAVTransport1C.$(objext) $(objdir)DvUpnpOrgAVTransport1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgAVTransport1.$(dllext) $(objdir)DvUpnpOrgAVTransport1C.$(objext) $(objdir)DvUpnpOrgAVTransport1.$(objext)
DvUpnpOrgAVTransport2Dll: $(objdir)$(dllprefix)DvUpnpOrgAVTransport2.$(dllext) 
$(objdir)$(dllprefix)DvUpnpOrgAVTransport2.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgAVTransport2C.$(objext) $(objdir)DvUpnpOrgAVTransport2.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgAVTransport2.$(dllext) $(objdir)DvUpnpOrgAVTransport2C.$(objext) $(objdir)DvUpnpOrgAVTransport2.$(objext)
DvUpnpOrgConnectionManager1Dll: $(objdir)$(dllprefix)DvUpnpOrgConnectionManager1.$(dllext) 
$(objdir)$(dllprefix)DvUpnpOrgConnectionManager1.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgConnectionManager1C.$(objext) $(objdir)DvUpnpOrgConnectionManager1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgConnectionManager1.$(dllext) $(objdir)DvUpnpOrgConnectionManager1C.$(objext) $(objdir)DvUpnpOrgConnectionManager1.$(objext)
DvUpnpOrgConnectionManager2Dll: $(objdir)$(dllprefix)DvUpnpOrgConnectionManager2.$(dllext) 
$(objdir)$(dllprefix)DvUpnpOrgConnectionManager2.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgConnectionManager2C.$(objext) $(objdir)DvUpnpOrgConnectionManager2.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgConnectionManager2.$(dllext) $(objdir)DvUpnpOrgConnectionManager2C.$(objext) $(objdir)DvUpnpOrgConnectionManager2.$(objext)
DvUpnpOrgContentDirectory1Dll: $(objdir)$(dllprefix)DvUpnpOrgContentDirectory1.$(dllext) 
$(objdir)$(dllprefix)DvUpnpOrgContentDirectory1.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgContentDirectory1C.$(objext) $(objdir)DvUpnpOrgContentDirectory1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgContentDirectory1.$(dllext) $(objdir)DvUpnpOrgContentDirectory1C.$(objext) $(objdir)DvUpnpOrgContentDirectory1.$(objext)
DvUpnpOrgContentDirectory2Dll: $(objdir)$(dllprefix)DvUpnpOrgContentDirectory2.$(dllext) 
$(objdir)$(dllprefix)DvUpnpOrgContentDirectory2.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgContentDirectory2C.$(objext) $(objdir)DvUpnpOrgContentDirectory2.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgContentDirectory2.$(dllext) $(objdir)DvUpnpOrgContentDirectory2C.$(objext) $(objdir)DvUpnpOrgContentDirectory2.$(objext)
DvUpnpOrgContentDirectory3Dll: $(objdir)$(dllprefix)DvUpnpOrgContentDirectory3.$(dllext) 
$(objdir)$(dllprefix)DvUpnpOrgContentDirectory3.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgContentDirectory3C.$(objext) $(objdir)DvUpnpOrgContentDirectory3.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgContentDirectory3.$(dllext) $(objdir)DvUpnpOrgContentDirectory3C.$(objext) $(objdir)DvUpnpOrgContentDirectory3.$(objext)
DvUpnpOrgRenderingControl1Dll: $(objdir)$(dllprefix)DvUpnpOrgRenderingControl1.$(dllext) 
$(objdir)$(dllprefix)DvUpnpOrgRenderingControl1.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgRenderingControl1C.$(objext) $(objdir)DvUpnpOrgRenderingControl1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgRenderingControl1.$(dllext) $(objdir)DvUpnpOrgRenderingControl1C.$(objext) $(objdir)DvUpnpOrgRenderingControl1.$(objext)
DvUpnpOrgRenderingControl2Dll: $(objdir)$(dllprefix)DvUpnpOrgRenderingControl2.$(dllext) 
$(objdir)$(dllprefix)DvUpnpOrgRenderingControl2.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgRenderingControl2C.$(objext) $(objdir)DvUpnpOrgRenderingControl2.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgRenderingControl2.$(dllext) $(objdir)DvUpnpOrgRenderingControl2C.$(objext) $(objdir)DvUpnpOrgRenderingControl2.$(objext)
DvUpnpOrgScheduledRecording1Dll: $(objdir)$(dllprefix)DvUpnpOrgScheduledRecording1.$(dllext) 
$(objdir)$(dllprefix)DvUpnpOrgScheduledRecording1.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgScheduledRecording1C.$(objext) $(objdir)DvUpnpOrgScheduledRecording1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgScheduledRecording1.$(dllext) $(objdir)DvUpnpOrgScheduledRecording1C.$(objext) $(objdir)DvUpnpOrgScheduledRecording1.$(objext)
DvUpnpOrgScheduledRecording2Dll: $(objdir)$(dllprefix)DvUpnpOrgScheduledRecording2.$(dllext) 
$(objdir)$(dllprefix)DvUpnpOrgScheduledRecording2.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgScheduledRecording2C.$(objext) $(objdir)DvUpnpOrgScheduledRecording2.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgScheduledRecording2.$(dllext) $(objdir)DvUpnpOrgScheduledRecording2C.$(objext) $(objdir)DvUpnpOrgScheduledRecording2.$(objext)
DvUpnpOrgSwitchPower1Dll: $(objdir)$(dllprefix)DvUpnpOrgSwitchPower1.$(dllext) 
$(objdir)$(dllprefix)DvUpnpOrgSwitchPower1.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgSwitchPower1C.$(objext) $(objdir)DvUpnpOrgSwitchPower1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgSwitchPower1.$(dllext) $(objdir)DvUpnpOrgSwitchPower1C.$(objext) $(objdir)DvUpnpOrgSwitchPower1.$(objext)
DvUpnpOrgDimming1Dll: $(objdir)$(dllprefix)DvUpnpOrgDimming1.$(dllext) 
$(objdir)$(dllprefix)DvUpnpOrgDimming1.$(dllext) : ZappUpnpDll $(objdir)DvUpnpOrgDimming1C.$(objext) $(objdir)DvUpnpOrgDimming1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvUpnpOrgDimming1.$(dllext) $(objdir)DvUpnpOrgDimming1C.$(objext) $(objdir)DvUpnpOrgDimming1.$(objext)
DvLinnCoUkComponent1Dll: $(objdir)$(dllprefix)DvLinnCoUkComponent1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkComponent1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkComponent1C.$(objext) $(objdir)DvLinnCoUkComponent1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkComponent1.$(dllext) $(objdir)DvLinnCoUkComponent1C.$(objext) $(objdir)DvLinnCoUkComponent1.$(objext)
DvLinnCoUkConfiguration1Dll: $(objdir)$(dllprefix)DvLinnCoUkConfiguration1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkConfiguration1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkConfiguration1C.$(objext) $(objdir)DvLinnCoUkConfiguration1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkConfiguration1.$(dllext) $(objdir)DvLinnCoUkConfiguration1C.$(objext) $(objdir)DvLinnCoUkConfiguration1.$(objext)
DvLinnCoUkDebug2Dll: $(objdir)$(dllprefix)DvLinnCoUkDebug2.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkDebug2.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkDebug2C.$(objext) $(objdir)DvLinnCoUkDebug2.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkDebug2.$(dllext) $(objdir)DvLinnCoUkDebug2C.$(objext) $(objdir)DvLinnCoUkDebug2.$(objext)
DvLinnCoUkDelay1Dll: $(objdir)$(dllprefix)DvLinnCoUkDelay1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkDelay1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkDelay1C.$(objext) $(objdir)DvLinnCoUkDelay1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkDelay1.$(dllext) $(objdir)DvLinnCoUkDelay1C.$(objext) $(objdir)DvLinnCoUkDelay1.$(objext)
DvLinnCoUkDiagnostics1Dll: $(objdir)$(dllprefix)DvLinnCoUkDiagnostics1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkDiagnostics1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkDiagnostics1C.$(objext) $(objdir)DvLinnCoUkDiagnostics1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkDiagnostics1.$(dllext) $(objdir)DvLinnCoUkDiagnostics1C.$(objext) $(objdir)DvLinnCoUkDiagnostics1.$(objext)
DvLinnCoUkDs1Dll: $(objdir)$(dllprefix)DvLinnCoUkDs1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkDs1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkDs1C.$(objext) $(objdir)DvLinnCoUkDs1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkDs1.$(dllext) $(objdir)DvLinnCoUkDs1C.$(objext) $(objdir)DvLinnCoUkDs1.$(objext)
DvLinnCoUkInfo1Dll: $(objdir)$(dllprefix)DvLinnCoUkInfo1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkInfo1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkInfo1C.$(objext) $(objdir)DvLinnCoUkInfo1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkInfo1.$(dllext) $(objdir)DvLinnCoUkInfo1C.$(objext) $(objdir)DvLinnCoUkInfo1.$(objext)
DvLinnCoUkJukebox1Dll: $(objdir)$(dllprefix)DvLinnCoUkJukebox1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkJukebox1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkJukebox1C.$(objext) $(objdir)DvLinnCoUkJukebox1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkJukebox1.$(dllext) $(objdir)DvLinnCoUkJukebox1C.$(objext) $(objdir)DvLinnCoUkJukebox1.$(objext)
DvLinnCoUkMediaTime1Dll: $(objdir)$(dllprefix)DvLinnCoUkMediaTime1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkMediaTime1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkMediaTime1C.$(objext) $(objdir)DvLinnCoUkMediaTime1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkMediaTime1.$(dllext) $(objdir)DvLinnCoUkMediaTime1C.$(objext) $(objdir)DvLinnCoUkMediaTime1.$(objext)
DvLinnCoUkPlaylist1Dll: $(objdir)$(dllprefix)DvLinnCoUkPlaylist1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkPlaylist1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkPlaylist1C.$(objext) $(objdir)DvLinnCoUkPlaylist1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkPlaylist1.$(dllext) $(objdir)DvLinnCoUkPlaylist1C.$(objext) $(objdir)DvLinnCoUkPlaylist1.$(objext)
DvLinnCoUkPreamp4Dll: $(objdir)$(dllprefix)DvLinnCoUkPreamp4.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkPreamp4.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkPreamp4C.$(objext) $(objdir)DvLinnCoUkPreamp4.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkPreamp4.$(dllext) $(objdir)DvLinnCoUkPreamp4C.$(objext) $(objdir)DvLinnCoUkPreamp4.$(objext)
DvLinnCoUkProduct1Dll: $(objdir)$(dllprefix)DvLinnCoUkProduct1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkProduct1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkProduct1C.$(objext) $(objdir)DvLinnCoUkProduct1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkProduct1.$(dllext) $(objdir)DvLinnCoUkProduct1C.$(objext) $(objdir)DvLinnCoUkProduct1.$(objext)
DvLinnCoUkProduct2Dll: $(objdir)$(dllprefix)DvLinnCoUkProduct2.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkProduct2.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkProduct2C.$(objext) $(objdir)DvLinnCoUkProduct2.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkProduct2.$(dllext) $(objdir)DvLinnCoUkProduct2C.$(objext) $(objdir)DvLinnCoUkProduct2.$(objext)
DvLinnCoUkProduct3Dll: $(objdir)$(dllprefix)DvLinnCoUkProduct3.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkProduct3.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkProduct3C.$(objext) $(objdir)DvLinnCoUkProduct3.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkProduct3.$(dllext) $(objdir)DvLinnCoUkProduct3C.$(objext) $(objdir)DvLinnCoUkProduct3.$(objext)
DvLinnCoUkProxyManager1Dll: $(objdir)$(dllprefix)DvLinnCoUkProxyManager1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkProxyManager1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkProxyManager1C.$(objext) $(objdir)DvLinnCoUkProxyManager1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkProxyManager1.$(dllext) $(objdir)DvLinnCoUkProxyManager1C.$(objext) $(objdir)DvLinnCoUkProxyManager1.$(objext)
DvLinnCoUkPtest1Dll: $(objdir)$(dllprefix)DvLinnCoUkPtest1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkPtest1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkPtest1C.$(objext) $(objdir)DvLinnCoUkPtest1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkPtest1.$(dllext) $(objdir)DvLinnCoUkPtest1C.$(objext) $(objdir)DvLinnCoUkPtest1.$(objext)
DvLinnCoUkRadio1Dll: $(objdir)$(dllprefix)DvLinnCoUkRadio1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkRadio1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkRadio1C.$(objext) $(objdir)DvLinnCoUkRadio1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkRadio1.$(dllext) $(objdir)DvLinnCoUkRadio1C.$(objext) $(objdir)DvLinnCoUkRadio1.$(objext)
DvLinnCoUkTime1Dll: $(objdir)$(dllprefix)DvLinnCoUkTime1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkTime1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkTime1C.$(objext) $(objdir)DvLinnCoUkTime1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkTime1.$(dllext) $(objdir)DvLinnCoUkTime1C.$(objext) $(objdir)DvLinnCoUkTime1.$(objext)
DvLinnCoUkUi2Dll: $(objdir)$(dllprefix)DvLinnCoUkUi2.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkUi2.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkUi2C.$(objext) $(objdir)DvLinnCoUkUi2.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkUi2.$(dllext) $(objdir)DvLinnCoUkUi2C.$(objext) $(objdir)DvLinnCoUkUi2.$(objext)
DvLinnCoUkVolkano1Dll: $(objdir)$(dllprefix)DvLinnCoUkVolkano1.$(dllext) 
$(objdir)$(dllprefix)DvLinnCoUkVolkano1.$(dllext) : ZappUpnpDll $(objdir)DvLinnCoUkVolkano1C.$(objext) $(objdir)DvLinnCoUkVolkano1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvLinnCoUkVolkano1.$(dllext) $(objdir)DvLinnCoUkVolkano1C.$(objext) $(objdir)DvLinnCoUkVolkano1.$(objext)
DvZappOrgTestBasic1Dll: $(objdir)$(dllprefix)DvZappOrgTestBasic1.$(dllext) 
$(objdir)$(dllprefix)DvZappOrgTestBasic1.$(dllext) : ZappUpnpDll $(objdir)DvZappOrgTestBasic1C.$(objext) $(objdir)DvZappOrgTestBasic1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvZappOrgTestBasic1.$(dllext) $(objdir)DvZappOrgTestBasic1C.$(objext) $(objdir)DvZappOrgTestBasic1.$(objext)
DvZappOrgTestWidget1Dll: $(objdir)$(dllprefix)DvZappOrgTestWidget1.$(dllext) 
$(objdir)$(dllprefix)DvZappOrgTestWidget1.$(dllext) : ZappUpnpDll $(objdir)DvZappOrgTestWidget1C.$(objext) $(objdir)DvZappOrgTestWidget1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvZappOrgTestWidget1.$(dllext) $(objdir)DvZappOrgTestWidget1C.$(objext) $(objdir)DvZappOrgTestWidget1.$(objext)
DvZappOrgTestWidgetController1Dll: $(objdir)$(dllprefix)DvZappOrgTestWidgetController1.$(dllext) 
$(objdir)$(dllprefix)DvZappOrgTestWidgetController1.$(dllext) : ZappUpnpDll $(objdir)DvZappOrgTestWidgetController1C.$(objext) $(objdir)DvZappOrgTestWidgetController1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvZappOrgTestWidgetController1.$(dllext) $(objdir)DvZappOrgTestWidgetController1C.$(objext) $(objdir)DvZappOrgTestWidgetController1.$(objext)
DvZappOrgTestLights1Dll: $(objdir)$(dllprefix)DvZappOrgTestLights1.$(dllext) 
$(objdir)$(dllprefix)DvZappOrgTestLights1.$(dllext) : ZappUpnpDll $(objdir)DvZappOrgTestLights1C.$(objext) $(objdir)DvZappOrgTestLights1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvZappOrgTestLights1.$(dllext) $(objdir)DvZappOrgTestLights1C.$(objext) $(objdir)DvZappOrgTestLights1.$(objext)

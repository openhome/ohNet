...
$(proxyCppCore)CpAvOpenhomeOrgTime1.cpp : $(tt) T4/Templates/CpUpnpCppBufferSource.tt T4/Templates/CpUpnpCppHeader.tt Service/Upnp/Linn/Time1.xml
	echo CpAvOpenhomeOrgTime1.cpp
	$(zappgen) --language=cppcore --stack=cp "--xml=Service/Upnp/Linn/Time1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=Time --version=1
...
$(proxyCppStd)CpAvOpenhomeOrgTime1Std.cpp : $(tt) T4/Templates/CpUpnpCppStringSource.tt T4/Templates/CpUpnpCppHeader.tt Service/Upnp/Linn/Time1.xml
	echo CpAvOpenhomeOrgTime1Std.cpp
	$(zappgen) --language=cpp --stack=cp "--xml=Service/Upnp/Linn/Time1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=Time --version=1
...
$(proxyC)CpAvOpenhomeOrgTime1C.cpp : $(tt) T4/Templates/CpUpnpCSource.tt T4/Templates/CpUpnpCHeader.tt Service/Upnp/Linn/Time1.xml
	echo CpAvOpenhomeOrgTime1C.cpp
	$(zappgen) --language=c --stack=cp "--xml=Service/Upnp/Linn/Time1.xml" --output=$(proxyC) --domain=av.openhome.org --type=Time --version=1
...
$(proxyCs)CpAvOpenhomeOrgTime1.cs : $(tt) T4/Templates/CpUpnpCs.tt Service/Upnp/Linn/Time1.xml
	echo CpAvOpenhomeOrgTime1.cs
	$(zappgen) --language=cs --stack=cp "--xml=Service/Upnp/Linn/Time1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=Time --version=1
...
$(proxyJs)CpAvOpenhomeOrgTime1.js : $(tt) T4/Templates/CpUpnpJs.tt Service/Upnp/Linn/Time1.xml
	echo CpAvOpenhomeOrgTime1.js
	$(zappgen) --language=js --stack=cp "--xml=Service/Upnp/Linn/Time1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=Time --version=1
...
$(deviceCppCore)DvAvOpenhomeOrgTime1.cpp : $(tt) T4/Templates/DvUpnpCppCoreSource.tt T4/Templates/DvUpnpCppCoreHeader.tt Service/Upnp/Linn/Time1.xml
	echo DvAvOpenhomeOrgTime1.cpp
	$(zappgen) --language=cppcore --stack=dv "--xml=Service/Upnp/Linn/Time1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=Time --version=1
...
$(deviceCppStd)DvAvOpenhomeOrgTime1Std.cpp : $(tt) T4/Templates/DvUpnpCppStdSource.tt T4/Templates/DvUpnpCppStdHeader.tt Service/Upnp/Linn/Time1.xml
	echo DvAvOpenhomeOrgTime1Std.cpp
	$(zappgen) --language=cpp --stack=dv "--xml=Service/Upnp/Linn/Time1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=Time --version=1
...
$(deviceC)DvAvOpenhomeOrgTime1C.cpp : $(tt) T4/Templates/DvUpnpCSource.tt T4/Templates/DvUpnpCHeader.tt Service/Upnp/Linn/Time1.xml
	echo DvAvOpenhomeOrgTime1C.cpp
	$(zappgen) --language=c --stack=dv "--xml=Service/Upnp/Linn/Time1.xml" --output=$(deviceC) --domain=av.openhome.org --type=Time --version=1
...
$(deviceCs)DvAvOpenhomeOrgTime1.cs : $(tt) T4/Templates/DvUpnpCs.tt Service/Upnp/Linn/Time1.xml
	echo DvAvOpenhomeOrgTime1.cs
	$(zappgen) --language=cs --stack=dv "--xml=Service/Upnp/Linn/Time1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=Time --version=1

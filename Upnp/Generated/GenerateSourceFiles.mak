...
$(proxyCppCore)CpZappOrgTestWidget1.cpp : $(tt) T4/Templates/CpUpnpCppBufferSource.tt T4/Templates/CpUpnpCppHeader.tt Service/Upnp/Zapp/Test/TestWidget1.xml
	echo CpZappOrgTestWidget1.cpp
	$(zappgen) --language=cppcore --stack=cp "--xml=Service/Upnp/Zapp/Test/TestWidget1.xml" --output=$(proxyCppCore) --domain=zapp.org --type=TestWidget --version=1
$(proxyCppCore)CpZappOrgTestWidgetController1.cpp : $(tt) T4/Templates/CpUpnpCppBufferSource.tt T4/Templates/CpUpnpCppHeader.tt Service/Upnp/Zapp/Test/TestWidgetController1.xml
	echo CpZappOrgTestWidgetController1.cpp
	$(zappgen) --language=cppcore --stack=cp "--xml=Service/Upnp/Zapp/Test/TestWidgetController1.xml" --output=$(proxyCppCore) --domain=zapp.org --type=TestWidgetController --version=1
...
$(proxyCppStd)CpZappOrgTestWidget1Std.cpp : $(tt) T4/Templates/CpUpnpCppStringSource.tt T4/Templates/CpUpnpCppHeader.tt Service/Upnp/Zapp/Test/TestWidget1.xml
	echo CpZappOrgTestWidget1Std.cpp
	$(zappgen) --language=cpp --stack=cp "--xml=Service/Upnp/Zapp/Test/TestWidget1.xml" --output=$(proxyCppStd) --domain=zapp.org --type=TestWidget --version=1
$(proxyCppStd)CpZappOrgTestWidgetController1Std.cpp : $(tt) T4/Templates/CpUpnpCppStringSource.tt T4/Templates/CpUpnpCppHeader.tt Service/Upnp/Zapp/Test/TestWidgetController1.xml
	echo CpZappOrgTestWidgetController1Std.cpp
	$(zappgen) --language=cpp --stack=cp "--xml=Service/Upnp/Zapp/Test/TestWidgetController1.xml" --output=$(proxyCppStd) --domain=zapp.org --type=TestWidgetController --version=1
...
$(proxyC)CpZappOrgTestWidget1C.cpp : $(tt) T4/Templates/CpUpnpCSource.tt T4/Templates/CpUpnpCHeader.tt Service/Upnp/Zapp/Test/TestWidget1.xml
	echo CpZappOrgTestWidget1C.cpp
	$(zappgen) --language=c --stack=cp "--xml=Service/Upnp/Zapp/Test/TestWidget1.xml" --output=$(proxyC) --domain=zapp.org --type=TestWidget --version=1
$(proxyC)CpZappOrgTestWidgetController1C.cpp : $(tt) T4/Templates/CpUpnpCSource.tt T4/Templates/CpUpnpCHeader.tt Service/Upnp/Zapp/Test/TestWidgetController1.xml
	echo CpZappOrgTestWidgetController1C.cpp
	$(zappgen) --language=c --stack=cp "--xml=Service/Upnp/Zapp/Test/TestWidgetController1.xml" --output=$(proxyC) --domain=zapp.org --type=TestWidgetController --version=1
...
$(proxyCs)CpZappOrgTestWidget1.cs : $(tt) T4/Templates/CpUpnpCs.tt Service/Upnp/Zapp/Test/TestWidget1.xml
	echo CpZappOrgTestWidget1.cs
	$(zappgen) --language=cs --stack=cp "--xml=Service/Upnp/Zapp/Test/TestWidget1.xml" --output=$(proxyCs) --domain=zapp.org --type=TestWidget --version=1
$(proxyCs)CpZappOrgTestWidgetController1.cs : $(tt) T4/Templates/CpUpnpCs.tt Service/Upnp/Zapp/Test/TestWidgetController1.xml
	echo CpZappOrgTestWidgetController1.cs
	$(zappgen) --language=cs --stack=cp "--xml=Service/Upnp/Zapp/Test/TestWidgetController1.xml" --output=$(proxyCs) --domain=zapp.org --type=TestWidgetController --version=1
...
$(proxyJs)CpZappOrgTestWidget1.js : $(tt) T4/Templates/CpUpnpJs.tt Service/Upnp/Zapp/Test/TestWidget1.xml
	echo CpZappOrgTestWidget1.js
	$(zappgen) --language=js --stack=cp "--xml=Service/Upnp/Zapp/Test/TestWidget1.xml" --output=$(proxyJs) --domain=zapp.org --type=TestWidget --version=1
$(proxyJs)CpZappOrgTestWidgetController1.js : $(tt) T4/Templates/CpUpnpJs.tt Service/Upnp/Zapp/Test/TestWidgetController1.xml
	echo CpZappOrgTestWidgetController1.js
	$(zappgen) --language=js --stack=cp "--xml=Service/Upnp/Zapp/Test/TestWidgetController1.xml" --output=$(proxyJs) --domain=zapp.org --type=TestWidgetController --version=1
...
$(deviceCppCore)DvZappOrgTestWidget1.cpp : $(tt) T4/Templates/DvUpnpCppCoreSource.tt T4/Templates/DvUpnpCppCoreHeader.tt Service/Upnp/Zapp/Test/TestWidget1.xml
	echo DvZappOrgTestWidget1.cpp
	$(zappgen) --language=cppcore --stack=dv "--xml=Service/Upnp/Zapp/Test/TestWidget1.xml" --output=$(deviceCppCore) --domain=zapp.org --type=TestWidget --version=1
$(deviceCppCore)DvZappOrgTestWidgetController1.cpp : $(tt) T4/Templates/DvUpnpCppCoreSource.tt T4/Templates/DvUpnpCppCoreHeader.tt Service/Upnp/Zapp/Test/TestWidgetController1.xml
	echo DvZappOrgTestWidgetController1.cpp
	$(zappgen) --language=cppcore --stack=dv "--xml=Service/Upnp/Zapp/Test/TestWidgetController1.xml" --output=$(deviceCppCore) --domain=zapp.org --type=TestWidgetController --version=1
...
$(deviceCppStd)DvZappOrgTestWidget1Std.cpp : $(tt) T4/Templates/DvUpnpCppStdSource.tt T4/Templates/DvUpnpCppStdHeader.tt Service/Upnp/Zapp/Test/TestWidget1.xml
	echo DvZappOrgTestWidget1Std.cpp
	$(zappgen) --language=cpp --stack=dv "--xml=Service/Upnp/Zapp/Test/TestWidget1.xml" --output=$(deviceCppStd) --domain=zapp.org --type=TestWidget --version=1
$(deviceCppStd)DvZappOrgTestWidgetController1Std.cpp : $(tt) T4/Templates/DvUpnpCppStdSource.tt T4/Templates/DvUpnpCppStdHeader.tt Service/Upnp/Zapp/Test/TestWidgetController1.xml
	echo DvZappOrgTestWidgetController1Std.cpp
	$(zappgen) --language=cpp --stack=dv "--xml=Service/Upnp/Zapp/Test/TestWidgetController1.xml" --output=$(deviceCppStd) --domain=zapp.org --type=TestWidgetController --version=1
...
$(deviceC)DvZappOrgTestWidget1C.cpp : $(tt) T4/Templates/DvUpnpCSource.tt T4/Templates/DvUpnpCHeader.tt Service/Upnp/Zapp/Test/TestWidget1.xml
	echo DvZappOrgTestWidget1C.cpp
	$(zappgen) --language=c --stack=dv "--xml=Service/Upnp/Zapp/Test/TestWidget1.xml" --output=$(deviceC) --domain=zapp.org --type=TestWidget --version=1
$(deviceC)DvZappOrgTestWidgetController1C.cpp : $(tt) T4/Templates/DvUpnpCSource.tt T4/Templates/DvUpnpCHeader.tt Service/Upnp/Zapp/Test/TestWidgetController1.xml
	echo DvZappOrgTestWidgetController1C.cpp
	$(zappgen) --language=c --stack=dv "--xml=Service/Upnp/Zapp/Test/TestWidgetController1.xml" --output=$(deviceC) --domain=zapp.org --type=TestWidgetController --version=1
...
$(deviceCs)DvZappOrgTestWidget1.cs : $(tt) T4/Templates/DvUpnpCs.tt Service/Upnp/Zapp/Test/TestWidget1.xml
	echo DvZappOrgTestWidget1.cs
	$(zappgen) --language=cs --stack=dv "--xml=Service/Upnp/Zapp/Test/TestWidget1.xml" --output=$(deviceCs) --domain=zapp.org --type=TestWidget --version=1
$(deviceCs)DvZappOrgTestWidgetController1.cs : $(tt) T4/Templates/DvUpnpCs.tt Service/Upnp/Zapp/Test/TestWidgetController1.xml
	echo DvZappOrgTestWidgetController1.cs
	$(zappgen) --language=cs --stack=dv "--xml=Service/Upnp/Zapp/Test/TestWidgetController1.xml" --output=$(deviceCs) --domain=zapp.org --type=TestWidgetController --version=1

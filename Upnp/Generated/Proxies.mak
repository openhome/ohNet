...
$(objdir)CpUpnpOrgAVTransport1Std.$(objext) : $(proxyCppStd)CpUpnpOrgAVTransport1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgAVTransport1.h
	$(compiler)CpUpnpOrgAVTransport1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgAVTransport1Std.cpp
$(objdir)CpUpnpOrgAVTransport2.$(objext) : $(proxyCppCore)CpUpnpOrgAVTransport2.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpUpnpOrgAVTransport2.h
	$(compiler)CpUpnpOrgAVTransport2.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpUpnpOrgAVTransport2.cpp
$(objdir)CpUpnpOrgAVTransport2C.$(objext) : $(proxyC)CpUpnpOrgAVTransport2C.cpp $(headers_proxy) ControlPoint/Services/C/CpUpnpOrgAVTransport2.h
	$(compiler)CpUpnpOrgAVTransport2C.$(objext) -c $(cflags) $(includes) $(proxyC)CpUpnpOrgAVTransport2C.cpp
$(objdir)CpUpnpOrgAVTransport2Std.$(objext) : $(proxyCppStd)CpUpnpOrgAVTransport2Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgAVTransport2.h
	$(compiler)CpUpnpOrgAVTransport2Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgAVTransport2Std.cpp
$(objdir)CpUpnpOrgConnectionManager1.$(objext) : $(proxyCppCore)CpUpnpOrgConnectionManager1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpUpnpOrgConnectionManager1.h
	$(compiler)CpUpnpOrgConnectionManager1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpUpnpOrgConnectionManager1.cpp
$(objdir)CpUpnpOrgConnectionManager1C.$(objext) : $(proxyC)CpUpnpOrgConnectionManager1C.cpp $(headers_proxy) ControlPoint/Services/C/CpUpnpOrgConnectionManager1.h
	$(compiler)CpUpnpOrgConnectionManager1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpUpnpOrgConnectionManager1C.cpp
$(objdir)CpUpnpOrgConnectionManager1Std.$(objext) : $(proxyCppStd)CpUpnpOrgConnectionManager1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgConnectionManager1.h
	$(compiler)CpUpnpOrgConnectionManager1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgConnectionManager1Std.cpp
$(objdir)CpUpnpOrgConnectionManager2.$(objext) : $(proxyCppCore)CpUpnpOrgConnectionManager2.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpUpnpOrgConnectionManager2.h
	$(compiler)CpUpnpOrgConnectionManager2.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpUpnpOrgConnectionManager2.cpp
$(objdir)CpUpnpOrgConnectionManager2C.$(objext) : $(proxyC)CpUpnpOrgConnectionManager2C.cpp $(headers_proxy) ControlPoint/Services/C/CpUpnpOrgConnectionManager2.h
	$(compiler)CpUpnpOrgConnectionManager2C.$(objext) -c $(cflags) $(includes) $(proxyC)CpUpnpOrgConnectionManager2C.cpp
$(objdir)CpUpnpOrgConnectionManager2Std.$(objext) : $(proxyCppStd)CpUpnpOrgConnectionManager2Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgConnectionManager2.h
	$(compiler)CpUpnpOrgConnectionManager2Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgConnectionManager2Std.cpp
$(objdir)CpUpnpOrgContentDirectory1.$(objext) : $(proxyCppCore)CpUpnpOrgContentDirectory1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpUpnpOrgContentDirectory1.h
	$(compiler)CpUpnpOrgContentDirectory1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpUpnpOrgContentDirectory1.cpp
$(objdir)CpUpnpOrgContentDirectory1C.$(objext) : $(proxyC)CpUpnpOrgContentDirectory1C.cpp $(headers_proxy) ControlPoint/Services/C/CpUpnpOrgContentDirectory1.h
	$(compiler)CpUpnpOrgContentDirectory1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpUpnpOrgContentDirectory1C.cpp
$(objdir)CpUpnpOrgContentDirectory1Std.$(objext) : $(proxyCppStd)CpUpnpOrgContentDirectory1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgContentDirectory1.h
	$(compiler)CpUpnpOrgContentDirectory1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgContentDirectory1Std.cpp
$(objdir)CpUpnpOrgContentDirectory2.$(objext) : $(proxyCppCore)CpUpnpOrgContentDirectory2.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpUpnpOrgContentDirectory2.h
	$(compiler)CpUpnpOrgContentDirectory2.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpUpnpOrgContentDirectory2.cpp
$(objdir)CpUpnpOrgContentDirectory2C.$(objext) : $(proxyC)CpUpnpOrgContentDirectory2C.cpp $(headers_proxy) ControlPoint/Services/C/CpUpnpOrgContentDirectory2.h
	$(compiler)CpUpnpOrgContentDirectory2C.$(objext) -c $(cflags) $(includes) $(proxyC)CpUpnpOrgContentDirectory2C.cpp
$(objdir)CpUpnpOrgContentDirectory2Std.$(objext) : $(proxyCppStd)CpUpnpOrgContentDirectory2Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgContentDirectory2.h
	$(compiler)CpUpnpOrgContentDirectory2Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgContentDirectory2Std.cpp
$(objdir)CpUpnpOrgContentDirectory3.$(objext) : $(proxyCppCore)CpUpnpOrgContentDirectory3.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpUpnpOrgContentDirectory3.h
	$(compiler)CpUpnpOrgContentDirectory3.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpUpnpOrgContentDirectory3.cpp
$(objdir)CpUpnpOrgContentDirectory3C.$(objext) : $(proxyC)CpUpnpOrgContentDirectory3C.cpp $(headers_proxy) ControlPoint/Services/C/CpUpnpOrgContentDirectory3.h
	$(compiler)CpUpnpOrgContentDirectory3C.$(objext) -c $(cflags) $(includes) $(proxyC)CpUpnpOrgContentDirectory3C.cpp
$(objdir)CpUpnpOrgContentDirectory3Std.$(objext) : $(proxyCppStd)CpUpnpOrgContentDirectory3Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgContentDirectory3.h
	$(compiler)CpUpnpOrgContentDirectory3Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgContentDirectory3Std.cpp
$(objdir)CpUpnpOrgRenderingControl1.$(objext) : $(proxyCppCore)CpUpnpOrgRenderingControl1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpUpnpOrgRenderingControl1.h
	$(compiler)CpUpnpOrgRenderingControl1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpUpnpOrgRenderingControl1.cpp
$(objdir)CpUpnpOrgRenderingControl1C.$(objext) : $(proxyC)CpUpnpOrgRenderingControl1C.cpp $(headers_proxy) ControlPoint/Services/C/CpUpnpOrgRenderingControl1.h
	$(compiler)CpUpnpOrgRenderingControl1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpUpnpOrgRenderingControl1C.cpp
$(objdir)CpUpnpOrgRenderingControl1Std.$(objext) : $(proxyCppStd)CpUpnpOrgRenderingControl1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgRenderingControl1.h
	$(compiler)CpUpnpOrgRenderingControl1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgRenderingControl1Std.cpp
$(objdir)CpUpnpOrgRenderingControl2.$(objext) : $(proxyCppCore)CpUpnpOrgRenderingControl2.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpUpnpOrgRenderingControl2.h
	$(compiler)CpUpnpOrgRenderingControl2.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpUpnpOrgRenderingControl2.cpp
$(objdir)CpUpnpOrgRenderingControl2C.$(objext) : $(proxyC)CpUpnpOrgRenderingControl2C.cpp $(headers_proxy) ControlPoint/Services/C/CpUpnpOrgRenderingControl2.h
	$(compiler)CpUpnpOrgRenderingControl2C.$(objext) -c $(cflags) $(includes) $(proxyC)CpUpnpOrgRenderingControl2C.cpp
$(objdir)CpUpnpOrgRenderingControl2Std.$(objext) : $(proxyCppStd)CpUpnpOrgRenderingControl2Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgRenderingControl2.h
	$(compiler)CpUpnpOrgRenderingControl2Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgRenderingControl2Std.cpp
$(objdir)CpUpnpOrgScheduledRecording1.$(objext) : $(proxyCppCore)CpUpnpOrgScheduledRecording1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpUpnpOrgScheduledRecording1.h
	$(compiler)CpUpnpOrgScheduledRecording1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpUpnpOrgScheduledRecording1.cpp
$(objdir)CpUpnpOrgScheduledRecording1C.$(objext) : $(proxyC)CpUpnpOrgScheduledRecording1C.cpp $(headers_proxy) ControlPoint/Services/C/CpUpnpOrgScheduledRecording1.h
	$(compiler)CpUpnpOrgScheduledRecording1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpUpnpOrgScheduledRecording1C.cpp
$(objdir)CpUpnpOrgScheduledRecording1Std.$(objext) : $(proxyCppStd)CpUpnpOrgScheduledRecording1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgScheduledRecording1.h
	$(compiler)CpUpnpOrgScheduledRecording1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgScheduledRecording1Std.cpp
$(objdir)CpUpnpOrgScheduledRecording2.$(objext) : $(proxyCppCore)CpUpnpOrgScheduledRecording2.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpUpnpOrgScheduledRecording2.h
	$(compiler)CpUpnpOrgScheduledRecording2.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpUpnpOrgScheduledRecording2.cpp
$(objdir)CpUpnpOrgScheduledRecording2C.$(objext) : $(proxyC)CpUpnpOrgScheduledRecording2C.cpp $(headers_proxy) ControlPoint/Services/C/CpUpnpOrgScheduledRecording2.h
	$(compiler)CpUpnpOrgScheduledRecording2C.$(objext) -c $(cflags) $(includes) $(proxyC)CpUpnpOrgScheduledRecording2C.cpp
$(objdir)CpUpnpOrgScheduledRecording2Std.$(objext) : $(proxyCppStd)CpUpnpOrgScheduledRecording2Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgScheduledRecording2.h
	$(compiler)CpUpnpOrgScheduledRecording2Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgScheduledRecording2Std.cpp
$(objdir)CpUpnpOrgSwitchPower1.$(objext) : $(proxyCppCore)CpUpnpOrgSwitchPower1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpUpnpOrgSwitchPower1.h
	$(compiler)CpUpnpOrgSwitchPower1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpUpnpOrgSwitchPower1.cpp
$(objdir)CpUpnpOrgSwitchPower1C.$(objext) : $(proxyC)CpUpnpOrgSwitchPower1C.cpp $(headers_proxy) ControlPoint/Services/C/CpUpnpOrgSwitchPower1.h
	$(compiler)CpUpnpOrgSwitchPower1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpUpnpOrgSwitchPower1C.cpp
$(objdir)CpUpnpOrgSwitchPower1Std.$(objext) : $(proxyCppStd)CpUpnpOrgSwitchPower1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgSwitchPower1.h
	$(compiler)CpUpnpOrgSwitchPower1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgSwitchPower1Std.cpp
$(objdir)CpUpnpOrgDimming1.$(objext) : $(proxyCppCore)CpUpnpOrgDimming1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpUpnpOrgDimming1.h
	$(compiler)CpUpnpOrgDimming1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpUpnpOrgDimming1.cpp
$(objdir)CpUpnpOrgDimming1C.$(objext) : $(proxyC)CpUpnpOrgDimming1C.cpp $(headers_proxy) ControlPoint/Services/C/CpUpnpOrgDimming1.h
	$(compiler)CpUpnpOrgDimming1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpUpnpOrgDimming1C.cpp
$(objdir)CpUpnpOrgDimming1Std.$(objext) : $(proxyCppStd)CpUpnpOrgDimming1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpUpnpOrgDimming1.h
	$(compiler)CpUpnpOrgDimming1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpUpnpOrgDimming1Std.cpp
$(objdir)CpAvOpenhomeOrgInfo1.$(objext) : $(proxyCppCore)CpAvOpenhomeOrgInfo1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpAvOpenhomeOrgInfo1.h
	$(compiler)CpAvOpenhomeOrgInfo1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpAvOpenhomeOrgInfo1.cpp
$(objdir)CpAvOpenhomeOrgInfo1C.$(objext) : $(proxyC)CpAvOpenhomeOrgInfo1C.cpp $(headers_proxy) ControlPoint/Services/C/CpAvOpenhomeOrgInfo1.h
	$(compiler)CpAvOpenhomeOrgInfo1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpAvOpenhomeOrgInfo1C.cpp
$(objdir)CpAvOpenhomeOrgInfo1Std.$(objext) : $(proxyCppStd)CpAvOpenhomeOrgInfo1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpAvOpenhomeOrgInfo1.h
	$(compiler)CpAvOpenhomeOrgInfo1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpAvOpenhomeOrgInfo1Std.cpp
$(objdir)CpAvOpenhomeOrgTime1.$(objext) : $(proxyCppCore)CpAvOpenhomeOrgTime1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpAvOpenhomeOrgTime1.h
	$(compiler)CpAvOpenhomeOrgTime1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpAvOpenhomeOrgTime1.cpp
$(objdir)CpAvOpenhomeOrgTime1C.$(objext) : $(proxyC)CpAvOpenhomeOrgTime1C.cpp $(headers_proxy) ControlPoint/Services/C/CpAvOpenhomeOrgTime1.h
	$(compiler)CpAvOpenhomeOrgTime1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpAvOpenhomeOrgTime1C.cpp
$(objdir)CpAvOpenhomeOrgTime1Std.$(objext) : $(proxyCppStd)CpAvOpenhomeOrgTime1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpAvOpenhomeOrgTime1.h
	$(compiler)CpAvOpenhomeOrgTime1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpAvOpenhomeOrgTime1Std.cpp
$(objdir)CpAvOpenhomeOrgPlaylist1.$(objext) : $(proxyCppCore)CpAvOpenhomeOrgPlaylist1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpAvOpenhomeOrgPlaylist1.h
	$(compiler)CpAvOpenhomeOrgPlaylist1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpAvOpenhomeOrgPlaylist1.cpp
$(objdir)CpAvOpenhomeOrgPlaylist1C.$(objext) : $(proxyC)CpAvOpenhomeOrgPlaylist1C.cpp $(headers_proxy) ControlPoint/Services/C/CpAvOpenhomeOrgPlaylist1.h
	$(compiler)CpAvOpenhomeOrgPlaylist1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpAvOpenhomeOrgPlaylist1C.cpp
$(objdir)CpAvOpenhomeOrgPlaylist1Std.$(objext) : $(proxyCppStd)CpAvOpenhomeOrgPlaylist1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpAvOpenhomeOrgPlaylist1.h
	$(compiler)CpAvOpenhomeOrgPlaylist1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpAvOpenhomeOrgPlaylist1Std.cpp
$(objdir)CpAvOpenhomeOrgVolume1.$(objext) : $(proxyCppCore)CpAvOpenhomeOrgVolume1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpAvOpenhomeOrgVolume1.h
	$(compiler)CpAvOpenhomeOrgVolume1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpAvOpenhomeOrgVolume1.cpp
$(objdir)CpAvOpenhomeOrgVolume1C.$(objext) : $(proxyC)CpAvOpenhomeOrgVolume1C.cpp $(headers_proxy) ControlPoint/Services/C/CpAvOpenhomeOrgVolume1.h
	$(compiler)CpAvOpenhomeOrgVolume1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpAvOpenhomeOrgVolume1C.cpp
$(objdir)CpAvOpenhomeOrgVolume1Std.$(objext) : $(proxyCppStd)CpAvOpenhomeOrgVolume1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpAvOpenhomeOrgVolume1.h
	$(compiler)CpAvOpenhomeOrgVolume1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpAvOpenhomeOrgVolume1Std.cpp
$(objdir)CpAvOpenhomeOrgProduct1.$(objext) : $(proxyCppCore)CpAvOpenhomeOrgProduct1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpAvOpenhomeOrgProduct1.h
	$(compiler)CpAvOpenhomeOrgProduct1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpAvOpenhomeOrgProduct1.cpp
$(objdir)CpAvOpenhomeOrgProduct1C.$(objext) : $(proxyC)CpAvOpenhomeOrgProduct1C.cpp $(headers_proxy) ControlPoint/Services/C/CpAvOpenhomeOrgProduct1.h
	$(compiler)CpAvOpenhomeOrgProduct1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpAvOpenhomeOrgProduct1C.cpp
$(objdir)CpAvOpenhomeOrgProduct1Std.$(objext) : $(proxyCppStd)CpAvOpenhomeOrgProduct1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpAvOpenhomeOrgProduct1.h
	$(compiler)CpAvOpenhomeOrgProduct1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpAvOpenhomeOrgProduct1Std.cpp
$(objdir)CpAvOpenhomeOrgRadio1.$(objext) : $(proxyCppCore)CpAvOpenhomeOrgRadio1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpAvOpenhomeOrgRadio1.h
	$(compiler)CpAvOpenhomeOrgRadio1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpAvOpenhomeOrgRadio1.cpp
$(objdir)CpAvOpenhomeOrgRadio1C.$(objext) : $(proxyC)CpAvOpenhomeOrgRadio1C.cpp $(headers_proxy) ControlPoint/Services/C/CpAvOpenhomeOrgRadio1.h
...
$(objdir)CpOpenhomeOrgTestColorLight1.$(objext) : $(proxyCppCore)CpOpenhomeOrgTestColorLight1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpOpenhomeOrgTestColorLight1.h
	$(compiler)CpOpenhomeOrgTestColorLight1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpOpenhomeOrgTestColorLight1.cpp
$(objdir)CpOpenhomeOrgTestColorLight1C.$(objext) : $(proxyC)CpOpenhomeOrgTestColorLight1C.cpp $(headers_proxy) ControlPoint/Services/C/CpOpenhomeOrgTestColorLight1.h
	$(compiler)CpOpenhomeOrgTestColorLight1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpOpenhomeOrgTestColorLight1C.cpp
$(objdir)CpOpenhomeOrgTestColorLight1Std.$(objext) : $(proxyCppStd)CpOpenhomeOrgTestColorLight1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpOpenhomeOrgTestColorLight1.h
	$(compiler)CpOpenhomeOrgTestColorLight1Std.$(objext) -c $(cflags) $(includes) $(proxyCppStd)CpOpenhomeOrgTestColorLight1Std.cpp
$(objdir)CpOpenhomeOrgOhNet1.$(objext) : $(proxyCppCore)CpOpenhomeOrgOhNet1.cpp $(headers_proxy) ControlPoint/Services/Cpp/Core/CpOpenhomeOrgOhNet1.h
	$(compiler)CpOpenhomeOrgOhNet1.$(objext) -c $(cflags) $(includes) $(proxyCppCore)CpOpenhomeOrgOhNet1.cpp
$(objdir)CpOpenhomeOrgOhNet1C.$(objext) : $(proxyC)CpOpenhomeOrgOhNet1C.cpp $(headers_proxy) ControlPoint/Services/C/CpOpenhomeOrgOhNet1.h
	$(compiler)CpOpenhomeOrgOhNet1C.$(objext) -c $(cflags) $(includes) $(proxyC)CpOpenhomeOrgOhNet1C.cpp
$(objdir)CpOpenhomeOrgOhNet1Std.$(objext) : $(proxyCppStd)CpOpenhomeOrgOhNet1Std.cpp $(headers_proxy) ControlPoint/Services/Cpp/Std/CpOpenhomeOrgOhNet1.h

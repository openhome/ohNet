...
gAllTests = [ TestCase('TestBuffer', [], True)
             ...
             ,TestCase('TestProxyC', [])
             ,TestCase('TestDviDiscovery', [], True)
             ,TestCase('TestDviDeviceList', [], True)
             ,TestCase('TestDvInvocation', [], True)
             ,TestCase('TestDvSubscription', [], True)
             ,TestCase('TestDvDeviceStd', [], True)
